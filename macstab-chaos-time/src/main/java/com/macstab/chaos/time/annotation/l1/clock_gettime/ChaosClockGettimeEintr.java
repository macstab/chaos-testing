...
/**
 * L1 chaos primitive: inject {@code EINTR} on every libchaos-time-intercepted
 * {@code clock_gettime} call, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> interrupted system call — signal delivery during sleep / clock read; canary for signal correctness.
 *
