...
/**
 * Delay the class_define operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the CLASS_DEFINE operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosClassDefineDelays}) to apply different configurations to different containers.
 *
