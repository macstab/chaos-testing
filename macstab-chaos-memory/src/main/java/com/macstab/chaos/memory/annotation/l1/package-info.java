 ...
 * grouped by selector into sub-packages ({@code mmap}, {@code mmap_anon}, {@code mmap_file},
 * {@code munmap}, {@code mprotect}, {@code madvise}, {@code wildcard}) so IDE autocomplete shows
 * only the family the developer is currently working with.
 *
 ...
 *       or {@link com.macstab.chaos.memory.annotation.l1.translators.MemoryLatencyTranslator} via
 *       its {@code @ChaosL1(translator = "...")} meta-annotation, and to a (selector, errno) or
