...
/**
 * L1 chaos primitive: reject the EXECUTOR_SHUTDOWN operation by throwing an appropriate exception for the operation type.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.EXECUTOR, operationType = OperationType.EXECUTOR_SHUTDOWN)
