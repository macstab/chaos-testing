 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the OBJECT_DESERIALIZE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosObjectDeserializeInjectExceptions}) to apply different configurations to different containers.
 *
