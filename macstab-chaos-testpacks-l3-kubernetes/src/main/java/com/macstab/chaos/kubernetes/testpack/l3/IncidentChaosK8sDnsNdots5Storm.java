 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Severe</strong><br>Every external HTTP/gRPC call takes 5–20 seconds until
 * CoreDNS autoscales; connection pools drain and thread pools fill with waiting callers.
 *
...
@ChaosL3(composer = "com.macstab.chaos.kubernetes.testpack.l3.composers.K8sDnsNdots5StormComposer", severity = Severity.SEVERE)
