...
/**
 * Injects {@code ENOMEM} on every libchaos-intercepted {@code posix spawn} call inside the target
 ...
 * exists only because {@code ENOMEM} is a valid POSIX result of {@code posix spawn}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEnomems}) to bind different probabilities
