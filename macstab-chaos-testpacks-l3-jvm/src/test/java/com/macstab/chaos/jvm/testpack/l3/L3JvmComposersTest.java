...
/**
 * Verifies that every JVM L3 incident annotation carries the {@link ChaosL3} meta-annotation
...
class L3JvmComposersTest {
    ...
    void safepointCascade_isRepeatable() {
        assertThat(IncidentChaosJvmSafepointCascade.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void codeCacheFull_isRepeatable() {
        assertThat(IncidentChaosJvmCodeCacheFull.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void carrierPinning_isRepeatable() {
        assertThat(IncidentChaosJvmCarrierPinning.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void metaspaceGlacier_isRepeatable() {
        assertThat(IncidentChaosJvmMetaspaceGlacier.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void g1ToSpaceExhausted_hasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosJvmG1ToSpaceExhausted.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void g1ToSpaceExhausted_isRepeatable() {
        assertThat(IncidentChaosJvmG1ToSpaceExhausted.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void gcLockerFakeOom_isRepeatable() {
        assertThat(IncidentChaosJvmGcLockerFakeOom.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void deoptimizationStorm_hasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosJvmDeoptimizationStorm.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void deoptimizationStorm_isRepeatable() {
        assertThat(IncidentChaosJvmDeoptimizationStorm.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void directMemoryLeak_isRepeatable() {
        assertThat(IncidentChaosJvmDirectMemoryLeak.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
