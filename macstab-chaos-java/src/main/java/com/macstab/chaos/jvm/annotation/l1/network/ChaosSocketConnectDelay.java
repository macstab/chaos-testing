...
/**
 * Delay the socket_connect operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the SOCKET_CONNECT operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosSocketConnectDelays}) to apply different configurations to different containers.
 *
