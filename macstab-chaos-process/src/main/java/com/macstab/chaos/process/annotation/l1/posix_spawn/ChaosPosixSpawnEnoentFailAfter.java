 ...
 * @ChaosPosixSpawnEnoentFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEnoentFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnEnoentFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnEnoentFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnEnoentFailAfter(id = "replica",  probability = 0.01)
