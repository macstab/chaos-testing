...
/**
 * Throw the configured exception at the jdbc_transaction_commit call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JDBC_TRANSACTION_COMMIT call site inside the JVM of the target container.
 ...
 * ({@code @ChaosJdbcTransactionCommitInjectExceptions}) to apply different configurations to different containers.
 *
