...
/**
 * Injects {@code EAI_FAIL} on every libchaos-intercepted {@code reverse} call inside the target
 ...
 * exists only because {@code EAI_FAIL} is a valid POSIX result of {@code reverse}.
 *
