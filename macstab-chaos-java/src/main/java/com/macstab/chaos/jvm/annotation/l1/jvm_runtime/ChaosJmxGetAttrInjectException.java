...
/**
 * Throw the configured exception at the jmx_get_attr call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JMX_GET_ATTR call site inside the JVM of the target container.
 ...
 * ({@code @ChaosJmxGetAttrInjectExceptions}) to apply different configurations to different containers.
 *
