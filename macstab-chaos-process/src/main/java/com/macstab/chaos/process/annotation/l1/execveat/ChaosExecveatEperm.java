...
/**
 * Injects {@code EPERM} on every libchaos-intercepted {@code execveat} call inside
 ...
 * @ChaosExecveatEperm(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosExecveatEperms}) to bind different probabilities to
