...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code waitpid} call inside
 ...
 * {@code waitpid}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code waitpid} call that the
 ...
 * @ChaosWaitpidEinval(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWaitpidEinvals}) to bind different probabilities to
