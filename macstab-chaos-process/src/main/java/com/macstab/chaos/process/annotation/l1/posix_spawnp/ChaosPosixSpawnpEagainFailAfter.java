 ...
 * (selector = {@code POSIX_SPAWNP}, errno = {@code EAGAIN}, effect = FAIL_AFTER) tuple.
 ...
 * ({@code @ChaosPosixSpawnpEagainFailAfter.Repeatable}) to apply different counters to different containers.
 *
