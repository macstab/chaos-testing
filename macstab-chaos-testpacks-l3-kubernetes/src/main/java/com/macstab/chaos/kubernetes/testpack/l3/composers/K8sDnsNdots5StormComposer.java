...
public final class K8sDnsNdots5StormComposer implements L3Composer<IncidentChaosK8sDnsNdots5Storm> {
    ...
    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosK8sDnsNdots5Storm ann) {
        ...
        handles.add(dns.apply(container, DnsRule.latency(DnsSelector.anyForward(), Duration.ofMillis(ann.latencyMs()))));
        return handles;
    }
