 ...
 * @ChaosExecveatEnomemFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosExecveatEnomemFailAfters}) to bind different probabilities to
...
public @interface ChaosExecveatEnomemFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosExecveatEnomemFailAfter(id = "primary",  probability = 0.001)
   * @ChaosExecveatEnomemFailAfter(id = "replica",  probability = 0.01)
