...
/**
 * Throw the configured exception at the dns_resolve call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the DNS_RESOLVE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosDnsResolveInjectExceptions}) to apply different configurations to different containers.
 *
