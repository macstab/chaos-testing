...
class DataIsolationSentinelTest {
  ...
  @AfterEach
  void cleanup(final List<SentinelCluster> clusters) {
  ...
  void shouldIsolateDataBetweenClusters() {
    ...
    final SentinelCluster clusterA = RedisSentinel.INSTANCE.get("cluster-a");
    final SentinelCluster clusterB = RedisSentinel.INSTANCE.get("cluster-b");
  ...
  void shouldReplicateWithinClusterOnly(final List<SentinelCluster> clusters) {
    final SentinelCluster clusterA = clusters.get(0); // cluster-a
    final SentinelCluster clusterB = clusters.get(1); // cluster-b
  ...
  void shouldHandleConcurrentWrites(final List<SentinelCluster> clusters) {
    final SentinelCluster clusterA = clusters.get(0);
    final SentinelCluster clusterB = clusters.get(1);
  ...
  private RedisClient createClient(final SentinelCluster cluster) {
    final String uri =
