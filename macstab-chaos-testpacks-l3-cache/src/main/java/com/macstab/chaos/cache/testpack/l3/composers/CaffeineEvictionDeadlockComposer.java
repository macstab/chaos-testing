 ...
 */
public final class CaffeineEvictionDeadlockComposer implements L3Composer<IncidentChaosCaffeineEvictionDeadlock> {

    public CaffeineEvictionDeadlockComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosCaffeineEvictionDeadlock ann) {
        ...
        final ChaosScenario sc = ChaosScenario.builder(id)
                ...
                .selector(ChaosSelector.method(
                        ...
                        NamePattern.any()))
                .effect(ChaosEffect.injectException("java.util.concurrent.TimeoutException", "Caffeine loader timed out"))
