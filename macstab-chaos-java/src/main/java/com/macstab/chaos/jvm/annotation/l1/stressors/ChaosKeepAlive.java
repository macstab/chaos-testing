...
/**
 * Activates a self-driving JVM stressor that spawn a thread that refuses to terminate inside the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor spawn a thread that refuses to
 * terminate. The effect persists throughout the test and is not probabilistic — it runs
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosKeepAlives}) to
