...
/**
 * Injects {@code EAI_SYSTEM} on every libchaos-intercepted {@code reverse} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosReverseEaisystems}) to bind different probabilities to
