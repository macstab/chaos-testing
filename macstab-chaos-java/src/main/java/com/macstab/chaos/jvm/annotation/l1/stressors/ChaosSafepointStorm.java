...
/**
 * Activates a self-driving JVM stressor that repeated System inside the target container's JVM for
 * the duration of the test class or test method.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor repeated System. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosSafepointStorms})
