 ...
 * @ChaosWaitpidEintrFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWaitpidEintrFailAfters}) to bind different probabilities to
...
public @interface ChaosWaitpidEintrFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWaitpidEintrFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWaitpidEintrFailAfter(id = "replica",  probability = 0.01)
