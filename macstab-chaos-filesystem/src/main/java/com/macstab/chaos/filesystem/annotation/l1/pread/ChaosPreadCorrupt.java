...
/**
 * Injects {@code ERRNO} on every libchaos-intercepted {@code pread} call inside the target
 ...
 * exists only because {@code ERRNO} is a valid POSIX result of {@code pread}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosPreadCorrupts}) to bind different probabilities to
