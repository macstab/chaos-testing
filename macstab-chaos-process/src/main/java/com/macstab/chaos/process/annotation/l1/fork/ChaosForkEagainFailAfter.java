...
/**
 * Injects {@code ERRNO} on every libchaos-intercepted {@code fork} call inside
 ...
 * {@code fork}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code fork} call that the
 ...
 * @ChaosForkEagainFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosForkEagainFailAfters}) to bind different probabilities to
...
public @interface ChaosForkEagainFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosForkEagainFailAfter(id = "primary",  probability = 0.001)
   * @ChaosForkEagainFailAfter(id = "replica",  probability = 0.01)
