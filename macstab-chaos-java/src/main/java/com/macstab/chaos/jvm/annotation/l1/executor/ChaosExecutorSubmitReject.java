 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the EXECUTOR_SUBMIT operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
