 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JMX_GET_ATTR
 ...
 * ({@code @ChaosJmxGetAttrInjectExceptions}) to apply different configurations to different
 * containers.
 *
