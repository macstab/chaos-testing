...
/**
 * Injects {@code EADDRINUSE} on every libchaos-intercepted {@code bind} call inside
 ...
 * {@code bind}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code bind} call that the
 ...
 * class. Use the repeatable form ({@code @ChaosBindEaddrinuses}) to bind different probabilities to
