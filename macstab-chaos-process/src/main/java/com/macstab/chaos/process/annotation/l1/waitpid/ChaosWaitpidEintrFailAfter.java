 ...
 * = {@code WAITPID}, errno = {@code EINTR}, effect = FAIL_AFTER) tuple. FAIL_AFTER is the process
 ...
 * every subsequent call returns {@code -1} with {@code errno = EINTR}, regardless of real kernel
 ...
 * ({@code @ChaosWaitpidEintrFailAfter.Repeatable}) to apply different counters to different
 * containers.
 *
