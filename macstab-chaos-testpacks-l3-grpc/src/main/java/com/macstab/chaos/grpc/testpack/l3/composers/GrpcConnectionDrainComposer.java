...
@Slf4j
public final class GrpcConnectionDrainComposer
    implements L3Composer<IncidentChaosGrpcConnectionDrain> {
  ...
  public List<Object> apply(
    ...
    final RuleHandle drainLagHandle =
        CompositeConnectionChaos.standard()
            .advanced()
            .apply(
                container,
    ...
    final ChaosScenario scenario =
        ChaosScenario.builder(scenarioId)
            .description(
                "L3 gRPC connection drain — GOAWAY ECONNRESET + SEND drain-lag + UNAVAILABLE")
            .selector(
    ...
    for (final Object h : handles) {
      if (h instanceof RuleHandle rh) {
        ...
        try {
          ...
          log.warn(
              "GrpcConnectionDrainComposer.removeAll: failed to remove JVM scenario {}",
              scenarioId,
              e);
        }
      }
