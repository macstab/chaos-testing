 ...
 * (selector = {@code WILDCARD}, errno = {@code ENOENT}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = ENOENT}, regardless of real
 ...
 * @ChaosWildcardEnoentFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosWildcardEnoentFailAfter.Repeatable}) to apply different counters to different containers.
 *
