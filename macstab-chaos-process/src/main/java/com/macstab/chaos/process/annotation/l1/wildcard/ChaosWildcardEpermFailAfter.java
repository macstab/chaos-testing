 ...
 * (selector = {@code WILDCARD}, errno = {@code EPERM}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = EPERM}, regardless of real
 ...
 * ({@code @ChaosWildcardEpermFailAfter.Repeatable}) to apply different counters to different containers.
 *
