...
/**
 * Delay the executor_shutdown operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the EXECUTOR_SHUTDOWN operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosExecutorShutdownDelays}) to apply different configurations to different containers.
 *
