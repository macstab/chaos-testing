...
/**
 * Injects {@code EPERM} on every libchaos-intercepted {@code execve} call inside
 ...
 * @ChaosExecveEperm(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosExecveEperms}) to bind different probabilities to
