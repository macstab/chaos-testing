 ...
 *
 * <p>Injects RECV latency to trigger Hystrix timeouts and injects HystrixTimeoutException at
 * METHOD_EXIT to activate the fallback, while the real thread remains blocked in {@code
 * socketRead0()} — reproducing the Netflix/Hystrix #1240 thread-leak pattern.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class FeignHystrixThreadLeakComposer
    implements L3Composer<IncidentChaosFeignHystrixThreadLeak> {

  public FeignHystrixThreadLeakComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosFeignHystrixThreadLeak ann) {
