 ...
 * @ChaosWaitpidEchildFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWaitpidEchildFailAfters}) to bind different probabilities to
...
public @interface ChaosWaitpidEchildFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWaitpidEchildFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWaitpidEchildFailAfter(id = "replica",  probability = 0.01)
