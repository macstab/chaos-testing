...
/**
 * <h2>What this is</h2>
 * <p>Simulates a cache stampede: a hot cache key expires and 100–1,000× concurrent requests race
 * to the backing database simultaneously. The resulting DB lock contention prevents the cache from
 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>DB locks → cache refill fails → death spiral.
 * Recovery requires either a cache warm-up strategy or circuit-breaker intervention.
 *
...
@ChaosL3(composer = "com.macstab.chaos.cache.testpack.l3.composers.CacheStampedeComposer", severity = Severity.CRITICAL)
