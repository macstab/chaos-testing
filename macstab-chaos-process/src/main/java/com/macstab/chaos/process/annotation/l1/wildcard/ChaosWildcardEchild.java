...
/**
 * Injects {@code ECHILD} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code ECHILD} is a valid POSIX result of {@code wildcard}.
 *
