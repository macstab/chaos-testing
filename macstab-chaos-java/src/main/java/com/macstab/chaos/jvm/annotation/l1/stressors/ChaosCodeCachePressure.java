...
/**
 * Activates a self-driving JVM stressor that force JIT to fill the code cache and fall back to interpreter inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor force JIT to fill the code cache and fall back to interpreter. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosCodeCachePressures}) to
