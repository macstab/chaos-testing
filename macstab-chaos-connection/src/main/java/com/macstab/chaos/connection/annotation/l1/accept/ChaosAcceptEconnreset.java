...
/**
 * L1 chaos primitive: inject {@code ECONNRESET} on every libchaos-net-intercepted
 * {@code accept} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> connection reset by peer — typical of mid-flight protocol errors, RST-on-close, load-balancer failover.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosAcceptEconnreset(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
 * <p><strong>Scope:</strong> applies to every {@code accept} call across all endpoints.
