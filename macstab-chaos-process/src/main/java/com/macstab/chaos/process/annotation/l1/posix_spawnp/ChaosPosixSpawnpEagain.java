...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code posix spawnp} call inside the target
 ...
 * exists only because {@code EAGAIN} is a valid POSIX result of {@code posix spawnp}.
 *
 ...
 * @ChaosPosixSpawnpEagain(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEagains}) to bind different probabilities
