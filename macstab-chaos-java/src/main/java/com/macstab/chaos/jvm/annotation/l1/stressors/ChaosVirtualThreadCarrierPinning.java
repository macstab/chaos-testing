...
/**
 * Activates a self-driving JVM stressor that pin virtual-thread carriers via synchronized blocks
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor pin virtual-thread carriers via
 * synchronized blocks. The effect persists throughout the test and is not probabilistic — it runs
 ...
 * ({@code @ChaosVirtualThreadCarrierPinnings}) to apply different stressor intensities to different
 * containers.
 *
