...
/**
 * Throw the configured exception at the jndi_lookup call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JNDI_LOOKUP call site inside the JVM of the target container.
 ...
 * ({@code @ChaosJndiLookupInjectExceptions}) to apply different configurations to different containers.
 *
