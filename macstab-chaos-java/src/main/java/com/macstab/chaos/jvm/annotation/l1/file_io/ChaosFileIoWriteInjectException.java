 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the FILE_IO_WRITE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosFileIoWriteInjectExceptions}) to apply different configurations to different containers.
 *
