...
/**
 * Injects {@code EAI_AGAIN} on every libchaos-intercepted {@code forward} call inside
 ...
 * @ChaosForwardEaiagain(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosForwardEaiagains}) to bind different probabilities to
