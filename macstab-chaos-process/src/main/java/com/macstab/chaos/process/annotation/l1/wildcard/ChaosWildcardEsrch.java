...
/**
 * Injects {@code ESRCH} on every libchaos-intercepted {@code wildcard} call inside
 ...
 * @ChaosWildcardEsrch(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEsrchs}) to bind different probabilities to
