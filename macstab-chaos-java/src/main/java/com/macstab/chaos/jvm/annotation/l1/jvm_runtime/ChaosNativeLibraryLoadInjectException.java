...
/**
 * Throw the configured exception at the native_library_load call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the NATIVE_LIBRARY_LOAD call site inside the JVM of the target container.
 ...
 * ({@code @ChaosNativeLibraryLoadInjectExceptions}) to apply different configurations to different containers.
 *
