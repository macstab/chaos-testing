 ...
 * @ChaosPosixSpawnEinvalFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEinvalFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnEinvalFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnEinvalFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnEinvalFailAfter(id = "replica",  probability = 0.01)
