 ...
 *
 * <p>Applies heap pressure, GC pressure, and filesystem read latency to reproduce the compound
 * failure profile of the swap death spiral: heap swapped to disk, GC forced to traverse swapped
 * pages producing a 45-second STW pause, liveness kill, repeat every 3 min.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class SystemSwapDeathSpiralComposer
    implements L3Composer<IncidentChaosSystemSwapDeathSpiral> {

  public SystemSwapDeathSpiralComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosSystemSwapDeathSpiral ann) {
    final List<Object> handles = new ArrayList<>();

    final String heapId =
        JvmPlanAccumulator.instance().mintScenarioId("SystemSwapDeathSpiral-heap");
