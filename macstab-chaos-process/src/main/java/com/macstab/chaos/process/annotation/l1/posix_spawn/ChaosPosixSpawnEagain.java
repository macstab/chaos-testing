...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code posix spawn} call inside the target
 ...
 * exists only because {@code EAGAIN} is a valid POSIX result of {@code posix spawn}.
 *
 ...
 * @ChaosPosixSpawnEagain(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEagains}) to bind different probabilities
