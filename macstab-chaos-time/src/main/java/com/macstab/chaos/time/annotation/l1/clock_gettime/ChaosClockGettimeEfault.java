...
/**
 * L1 chaos primitive: inject {@code EFAULT} on every libchaos-time-intercepted
 * {@code clock_gettime} call, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> bad address — typical of unhandled SIGSEGV-adjacent edge cases at the syscall boundary.
 *
