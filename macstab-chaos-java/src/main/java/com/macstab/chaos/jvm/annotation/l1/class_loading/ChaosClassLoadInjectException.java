 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the CLASS_LOAD
 ...
 * ({@code @ChaosClassLoadInjectExceptions}) to apply different configurations to different
 * containers.
 *
