 ...
 * @ChaosWildcardEmfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEmfileFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEmfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEmfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEmfileFailAfter(id = "replica",  probability = 0.01)
