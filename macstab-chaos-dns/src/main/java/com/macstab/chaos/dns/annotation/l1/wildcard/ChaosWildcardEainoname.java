...
/**
 * Injects {@code EAI_NONAME} on every libchaos-intercepted {@code wildcard} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEainonames}) to bind different probabilities to
