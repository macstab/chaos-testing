...
/**
 * Reject the http_client_send operation by throwing an appropriate exception for the operation type.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the HTTP_CLIENT_SEND operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
