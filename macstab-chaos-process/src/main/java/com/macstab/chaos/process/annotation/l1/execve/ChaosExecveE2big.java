...
/**
 * Injects {@code E2BIG} on every libchaos-intercepted {@code execve} call inside
 ...
 * @ChaosExecveE2big(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosExecveE2bigs}) to bind different probabilities to
