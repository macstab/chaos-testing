...
/**
 * Delays every libchaos-memory-intercepted {@code madvise} call by {@link #delayMs} milliseconds
 ...
 * = {@code MADVISE}, effect = LATENCY) pair. Unlike the errno variants, the latency primitive
 ...
 * starts. The shared library interposes the libc wrappers for the {@code MADVISE} syscall family.
 ...
 * ({@code @ChaosMadviseLatencys}) to set different delays on different containers simultaneously.
 *
