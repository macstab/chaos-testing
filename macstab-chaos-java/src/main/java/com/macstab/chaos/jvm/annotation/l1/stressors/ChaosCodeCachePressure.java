...
/**
 * Activates a self-driving JVM stressor that force JIT to fill the code cache and fall back to
 * interpreter inside the target container's JVM for the duration of the test class or test method.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor force JIT to fill the code cache and
 * fall back to interpreter. The effect persists throughout the test and is not probabilistic — it
 ...
 * ({@code @ChaosCodeCachePressures}) to apply different stressor intensities to different
 * containers.
 *
