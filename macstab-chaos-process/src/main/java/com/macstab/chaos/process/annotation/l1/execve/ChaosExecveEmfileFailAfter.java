 ...
 * @ChaosExecveEmfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosExecveEmfileFailAfters}) to bind different probabilities to
...
public @interface ChaosExecveEmfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosExecveEmfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosExecveEmfileFailAfter(id = "replica",  probability = 0.01)
