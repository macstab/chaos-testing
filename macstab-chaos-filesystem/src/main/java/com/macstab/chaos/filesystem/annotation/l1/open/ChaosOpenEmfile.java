...
/**
 * L1 chaos primitive: inject {@code EMFILE} on every libchaos-io-intercepted
 * {@code open} syscall, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> per-process fd limit reached — typical of fd-leaks in file handlers.
 *
