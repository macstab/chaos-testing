...
/**
 * L1 chaos primitive: silently suppress the ASYNC_CANCEL operation; callers receive null/false/no-op per operation semantics.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.ASYNC, operationType = OperationType.ASYNC_CANCEL)
