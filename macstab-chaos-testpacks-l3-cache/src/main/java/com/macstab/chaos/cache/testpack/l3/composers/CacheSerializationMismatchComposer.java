 ...
 */
public final class CacheSerializationMismatchComposer implements L3Composer<IncidentChaosCacheSerializationMismatch> {

    public CacheSerializationMismatchComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosCacheSerializationMismatch ann) {
        ...
        final ChaosScenario sc = ChaosScenario.builder(id)
                ...
                .selector(ChaosSelector.method(
                        ...
                        NamePattern.any()))
                .effect(ChaosEffect.injectException("java.io.InvalidClassException", "serialVersionUID mismatch"))
