...
/**
 * Injects {@code EPERM} on every libchaos-intercepted {@code clock gettime} call inside
 ...
 * @ChaosClockGettimeEperm(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosClockGettimeEperms}) to bind different probabilities to
