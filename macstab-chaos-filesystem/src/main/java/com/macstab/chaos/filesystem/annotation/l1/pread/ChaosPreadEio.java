...
/**
 * Injects {@code EIO} on every libchaos-intercepted {@code pread} call inside the target container,
 ...
 * exists only because {@code EIO} is a valid POSIX result of {@code pread}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code pread} call that the libchaos
 ...
 * class. Use the repeatable form ({@code @ChaosPreadEios}) to bind different probabilities to
