...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code wildcard} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEinvals}) to bind different probabilities to
