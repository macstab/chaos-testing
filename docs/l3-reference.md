...
<!-- TOC -->
* [L3 Incident Annotation Reference](#l3-incident-annotation-reference)
  * [Table of Contents](#table-of-contents)
  * [Redis (`macstab-chaos-testpacks-l3-redis`)](#redis-macstab-chaos-testpacks-l3-redis)
    * [`@IncidentChaosRedisFailoverStorm` — ⚠️ CRITICAL](#incidentchaosredisfailoverstorm---critical)
    * [`@IncidentChaosRedisNetworkFlap` — ⚠️ CRITICAL](#incidentchaosredisnetworkflap---critical)
    * [`@IncidentChaosRedisCacheAvalanche` — ⚠️ CRITICAL](#incidentchaosrediscacheavalanche---critical)
    * [`@IncidentChaosRedisOomEviction` — 🔶 SEVERE](#incidentchaosredisoomeviction---severe)
    * [`@IncidentChaosRedisClockDrift` — 🔷 MODERATE](#incidentchaosredisclockdrift---moderate)
    * [`@IncidentChaosRedisSlowlog` — 🔷 MODERATE](#incidentchaosredisslowlog---moderate)
  * [JDBC / Database (`macstab-chaos-testpacks-l3-jdbc`)](#jdbc--database-macstab-chaos-testpacks-l3-jdbc)
    * [`@IncidentChaosJdbcConnectionStorm` — ⚠️ CRITICAL](#incidentchaosjdbcconnectionstorm---critical)
    * [`@IncidentChaosJdbcPrimaryFailover` — ⚠️ CRITICAL](#incidentchaosjdbcprimaryfailover---critical)
    * [`@IncidentChaosJdbcNetworkPartition` — ⚠️ CRITICAL](#incidentchaosjdbcnetworkpartition---critical)
    * [`@IncidentChaosJdbcWalPressure` — 🔶 SEVERE](#incidentchaosjdbcwalpressure---severe)
    * [`@IncidentChaosJdbcDiskFull` — 🔶 SEVERE](#incidentchaosjdbcdiskfull---severe)
    * [`@IncidentChaosJdbcSequenceIdJump` — 🔶 SEVERE](#incidentchaosjdbcsequenceidjump---severe)
  * [HTTP (`macstab-chaos-testpacks-l3-http`)](#http-macstab-chaos-testpacks-l3-http)
    * [`@IncidentChaosHttpCascadingTimeout` — ⚠️ CRITICAL](#incidentchaoshttpcascadingtimeout---critical)
    * [`@IncidentChaosHttpRetryAmplification` — ⚠️ CRITICAL](#incidentchaoshttpretryamplification---critical)
    * [`@IncidentChaosHttpPartialOutage` — 🔶 SEVERE](#incidentchaoshttppartialoutage---severe)
    * [`@IncidentChaosHttpSslHandshakeStorm` — 🔶 SEVERE](#incidentchaoshttpsslhandshakestorm---severe)
  * [gRPC (`macstab-chaos-testpacks-l3-grpc`)](#grpc-macstab-chaos-testpacks-l3-grpc)
    * [`@IncidentChaosGrpcDeadlinePropagation` — ⚠️ CRITICAL](#incidentchaosgrpcdeadlinepropagation---critical)
    * [`@IncidentChaosGrpcGoawayStorm` — 🔶 SEVERE](#incidentchaosgrpcgoawaystorm---severe)
    * [`@IncidentChaosGrpcConnectionDrain` — 🔶 SEVERE](#incidentchaosgrpcconnectiondrain---severe)
    * [`@IncidentChaosGrpcLoadBalancingFailure` — 🔶 SEVERE](#incidentchaosgrpcloadbalancingfailure---severe)
  * [Kafka (`macstab-chaos-testpacks-l3-kafka`)](#kafka-macstab-chaos-testpacks-l3-kafka)
    * [`@IncidentChaosKafkaBrokerFailure` — ⚠️ CRITICAL](#incidentchaoskafkabrokerfailure---critical)
    * [`@IncidentChaosKafkaZookeeperLoss` — ⚠️ CRITICAL](#incidentchaoskafkazookeeperloss---critical)
    * [`@IncidentChaosKafkaUncleanLeaderElection` — ⚠️ CRITICAL](#incidentchaoskafkauncleanleaderelection---critical)
    * [`@IncidentChaosKafkaStoragePressure` — 🔶 SEVERE](#incidentchaoskafkastoragepressure---severe)
    * [`@IncidentChaosKafkaConsumerRebalance` — 🔶 SEVERE](#incidentchaoskafkaconsumerrebalance---severe)
    * [`@IncidentChaosKafkaClockDrift` — 🔷 MODERATE](#incidentchaoskafkaclockdrift---moderate)
    * [`@IncidentChaosKafkaNetworkDegradation` — 🔷 MODERATE](#incidentchaoskafkanetworkdegradation---moderate)
  * [Spring Boot (`macstab-chaos-testpacks-l3-spring-boot`)](#spring-boot-macstab-chaos-testpacks-l3-spring-boot)
    * [`@IncidentChaosSpringStartupFailure` — ⚠️ CRITICAL](#incidentchaosspringstartupfailure---critical)
    * [`@IncidentChaosSpringDatabaseOutage` — ⚠️ CRITICAL](#incidentchaosspringdatabaseoutage---critical)
    * [`@IncidentChaosSpringMemoryCrisis` — ⚠️ CRITICAL](#incidentchaosspringmemorycrisis---critical)
    * [`@IncidentChaosSpringConfigServerDown` — 🔶 SEVERE](#incidentchaosspringconfigserverdown---severe)
    * [`@IncidentChaosSpringGracefulShutdown` — 🔶 SEVERE](#incidentchaosspringgracefulshutdown---severe)
  * [JVM Internals (`macstab-chaos-testpacks-l3-jvm`)](#jvm-internals-macstab-chaos-testpacks-l3-jvm)
    * [`@IncidentChaosJvmCarrierPinning` — ⚠️ CRITICAL](#incidentchaosjvmcarrierpinning---critical)
    * [`@IncidentChaosJvmG1ToSpaceExhausted` — ⚠️ CRITICAL](#incidentchaosjvmg1tospaceexhausted---critical)
    * [`@IncidentChaosJvmCodeCacheFull` — ⚠️ CRITICAL](#incidentchaosjvmcodecachefull---critical)
    * [`@IncidentChaosJvmSafepointCascade` — ⚠️ CRITICAL](#incidentchaosjvmsafepointcascade---critical)
    * [`@IncidentChaosJvmMetaspaceGlacier` — 🔶 SEVERE](#incidentchaosjvmmetaspaceglacier---severe)
    * [`@IncidentChaosJvmGcLockerFakeOom` — 🔶 SEVERE](#incidentchaosjvmgclockerfakeoom---severe)
    * [`@IncidentChaosJvmDeoptimizationStorm` — 🔶 SEVERE](#incidentchaosjvmdeoptimizationstorm---severe)
    * [`@IncidentChaosJvmDirectMemoryLeak` — 🔶 SEVERE](#incidentchaosjvmdirectmemoryleak---severe)
  * [Kubernetes (`macstab-chaos-testpacks-l3-kubernetes`)](#kubernetes-macstab-chaos-testpacks-l3-kubernetes)
    * [`@IncidentChaosK8sRollingUpdateRst` — ⚠️ CRITICAL](#incidentchaosk8srollingupdaterst---critical)
    * [`@IncidentChaosK8sOomKillMidGc` — ⚠️ CRITICAL](#incidentchaosk8soomkillmidgc---critical)
    * [`@IncidentChaosK8sCpuThrottleGcAmplification` — ⚠️ CRITICAL](#incidentchaosk8scputhrottlegcamplification---critical)
    * [`@IncidentChaosK8sDnsNdots5Storm` — 🔶 SEVERE](#incidentchaosk8sdnsndots5storm---severe)
    * [`@IncidentChaosK8sSidecarShutdownRace` — 🔶 SEVERE](#incidentchaosk8ssidecarshutdownrace---severe)
  * [Cache (`macstab-chaos-testpacks-l3-cache`)](#cache-macstab-chaos-testpacks-l3-cache)
    * [`@IncidentChaosCacheStampede` — ⚠️ CRITICAL](#incidentchaoscachestampede---critical)
    * [`@IncidentChaosCacheWarmingFailure` — ⚠️ CRITICAL](#incidentchaoscachewarmingfailure---critical)
    * [`@IncidentChaosHazelcastSplitBrain` — ⚠️ CRITICAL](#incidentchaoshazelcastsplitbrain---critical)
    * [`@IncidentChaosCacheSerializationMismatch` — 🔶 SEVERE](#incidentchaoscacheserializationmismatch---severe)
    * [`@IncidentChaosCaffeineEvictionDeadlock` — 🔶 SEVERE](#incidentchaoscaffeineevictiondeadlock---severe)
  * [Spring Framework (`macstab-chaos-testpacks-l3-spring`)](#spring-framework-macstab-chaos-testpacks-l3-spring)
    * [`@IncidentChaosSpringTransactionalPoolDeadlock` — ⚠️ CRITICAL](#incidentchaosspringtransactionalpooldeadlock---critical)
    * [`@IncidentChaosSpringWebFluxReactorStarvation` — ⚠️ CRITICAL](#incidentchaosspringwebfluxreactorstarvation---critical)
    * [`@IncidentChaosSpringConfigRefreshWave` — 🔶 SEVERE](#incidentchaosspringconfigrefreshwave---severe)
    * [`@IncidentChaosSpringOsivConnectionStarvation` — 🔶 SEVERE](#incidentchaosspringosivconnectionstarvation---severe)
  * [Feign / HTTP Clients (`macstab-chaos-testpacks-l3-feign`)](#feign--http-clients-macstab-chaos-testpacks-l3-feign)
    * [`@IncidentChaosFeignHystrixThreadLeak` — ⚠️ CRITICAL](#incidentchaosfeignhystrixthreadleak---critical)
    * [`@IncidentChaosFeignChunkedConnectionLeak` — 🔶 SEVERE](#incidentchaosfeignchunkedconnectionleak---severe)
    * [`@IncidentChaosFeignRetryAmplification` — 🔶 SEVERE](#incidentchaosfeignretryamplification---severe)
    * [`@IncidentChaosOkHttpMetastablePool` — 🔶 SEVERE](#incidentchaosokhttpmetastablepool---severe)
    * [`@IncidentChaosFeignStaleLoadBalancer` — 🔷 MODERATE](#incidentchaosfeignstaleloadbalancer---moderate)
  * [System / OS (`macstab-chaos-testpacks-l3-system`)](#system--os-macstab-chaos-testpacks-l3-system)
    * [`@IncidentChaosSystemInodeExhaustion` — ⚠️ CRITICAL](#incidentchaossysteminodeexhaustion---critical)
    * [`@IncidentChaosSystemFdExhaustion` — ⚠️ CRITICAL](#incidentchaossystemfdexhaustion---critical)
    * [`@IncidentChaosSystemSwapDeathSpiral` — ⚠️ CRITICAL](#incidentchaossystemswapdeathspiral---critical)
    * [`@IncidentChaosSystemTcpTimeWaitStorm` — 🔶 SEVERE](#incidentchaossystemtcptimewaitstorm---severe)
    * [`@IncidentChaosSystemDirectMemoryLeak` — 🔶 SEVERE](#incidentchaossystemdirectmemoryleak---severe)
