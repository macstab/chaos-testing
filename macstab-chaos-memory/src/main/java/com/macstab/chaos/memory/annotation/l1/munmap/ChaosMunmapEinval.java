...
/**
 * Injects {@code EINVAL} on every libchaos-memory-intercepted {@code munmap} call inside the target
 * container, making the call fail as if the kernel returned {@code EINVAL}.
 *
 * <p><strong>What this annotation is:</strong> an L1 chaos primitive — the smallest declarative
 * chaos unit. It encodes exactly one (selector = {@code MUNMAP}, errno = {@code EINVAL}) pair. The
 ...
 * the test class. Use the repeatable form ({@code @ChaosMunmapEinvals}) to bind different
