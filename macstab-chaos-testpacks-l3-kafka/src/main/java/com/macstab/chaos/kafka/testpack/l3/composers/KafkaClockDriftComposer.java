 ...
 *
 * <p>Shifts the realtime clock and adds RECV jitter to reproduce the compound failure profile
 * of Kafka timestamp routing under NTP desynchronisation, combined with a JVM TimestampException
 * to exercise application-level handling of timestamp-based routing errors.
 *
...
public final class KafkaClockDriftComposer implements L3Composer<IncidentChaosKafkaClockDrift> {
    ...
    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosKafkaClockDrift ann) {
