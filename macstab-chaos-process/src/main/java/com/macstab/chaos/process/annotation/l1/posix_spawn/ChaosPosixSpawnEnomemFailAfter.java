 ...
 * (selector = {@code POSIX_SPAWN}, errno = {@code ENOMEM}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosPosixSpawnEnomemFailAfter(successesBeforeFailure = 128)
 ...
 * {@code posix_spawn} calls the application is expected to make before hitting the limit.
 ...
 * ({@code @ChaosPosixSpawnEnomemFailAfter.Repeatable}) to apply different counters to different containers.
 *
