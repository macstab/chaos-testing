 ...
 * (selector = {@code PTHREAD_CREATE}, errno = {@code EINVAL}, effect = FAIL_AFTER) tuple.
 ...
 * {@code pthread_create} calls. After {@link #successesBeforeFailure} successes the counter trips and
 ...
 * @ChaosPthreadCreateEinvalFailAfter(successesBeforeFailure = 128)
 ...
 * {@code pthread_create} calls the application is expected to make before hitting the limit.
 ...
 * ({@code @ChaosPthreadCreateEinvalFailAfter.Repeatable}) to apply different counters to different containers.
 *
