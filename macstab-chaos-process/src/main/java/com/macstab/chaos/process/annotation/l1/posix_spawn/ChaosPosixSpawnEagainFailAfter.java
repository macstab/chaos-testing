 ...
 * (selector = {@code POSIX_SPAWN}, errno = {@code EAGAIN}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosPosixSpawnEagainFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosPosixSpawnEagainFailAfter.Repeatable}) to apply different counters to different containers.
 *
