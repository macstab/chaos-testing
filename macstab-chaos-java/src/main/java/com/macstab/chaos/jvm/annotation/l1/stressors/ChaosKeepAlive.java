...
/**
 * Activates a self-driving JVM stressor that spawn a thread that refuses to terminate inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor spawn a thread that refuses to terminate. The effect persists
