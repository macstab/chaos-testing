...
/**
 * L1 chaos primitive: skew the value returned from ZONED_DATE_TIME_NOW.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#ZONED_DATE_TIME_NOW
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.ZONED_DATE_TIME_NOW)
