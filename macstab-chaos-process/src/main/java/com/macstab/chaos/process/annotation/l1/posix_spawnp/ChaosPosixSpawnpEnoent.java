...
/**
 * Injects {@code ENOENT} on every libchaos-intercepted {@code posix spawnp} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnoents}) to bind different probabilities to
