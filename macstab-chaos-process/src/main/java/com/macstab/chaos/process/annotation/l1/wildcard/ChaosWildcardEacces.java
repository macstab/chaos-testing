...
/**
 * L1 chaos primitive: inject {@code EACCES} on every libchaos-process-intercepted {@code every
 ...
 * @ChaosWildcardEacces(probability = 0.01)
 * class MyTest { ... }
 * }</pre>
 *
 * <p><strong>Probability guidance:</strong> {@code 1e-3} to {@code 1e-2} mirrors realistic
 * production rates for {@code EACCES} on {@code every interposed process syscall}; {@code 1.0}
