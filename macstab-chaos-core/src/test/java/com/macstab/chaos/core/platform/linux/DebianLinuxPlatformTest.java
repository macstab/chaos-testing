...
/**
 * Unit tests for {@link DebianLinuxPlatform}.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
@DisplayName("DebianLinuxPlatform")
class DebianLinuxPlatformTest {

  private Platform platform;

  @BeforeEach
  void setUp() {
    platform = new DebianLinuxPlatform();
  }
  ...
  class PlatformMetadata {
    ...
    @Test
    @DisplayName("should return debian distribution name")
    void shouldReturnDebianDistributionName() {
