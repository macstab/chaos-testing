 ...
 *
 * <p>Applies ECONNRESET on both CONNECT and RECV to reproduce rapid TCP reset cycling that
 * triggers Sentinel election storms where master appears to change every 200ms.
 *
...
public final class RedisNetworkFlapComposer implements L3Composer<IncidentChaosRedisNetworkFlap> {
    ...
    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosRedisNetworkFlap ann) {
