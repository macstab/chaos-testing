 ...
 * @ChaosPosixSpawnEmfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEmfileFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnEmfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnEmfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnEmfileFailAfter(id = "replica",  probability = 0.01)
