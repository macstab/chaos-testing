 ...
 * service losing its database — the canonical trigger for Resilience4j circuit breaker opening
 * and readiness probe failure.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class SpringDatabaseOutageComposer implements L3Composer<IncidentChaosSpringDatabaseOutage> {

    public SpringDatabaseOutageComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosSpringDatabaseOutage ann) {
    ...
    public List<String> describe(final IncidentChaosSpringDatabaseOutage ann) {
        return List.of(
                ...
                "jvm: DataAccessResourceFailureException on class prefix '" + ann.classPattern() + "' (METHOD_ENTER)",
