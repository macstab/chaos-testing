 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JDBC_TRANSACTION_ROLLBACK call site inside the JVM of the target container.
 ...
 * ({@code @ChaosJdbcTransactionRollbackInjectExceptions}) to apply different configurations to different containers.
 *
