...
/**
 * Throw the configured exception at the jdbc_connection_acquire call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JDBC_CONNECTION_ACQUIRE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosJdbcConnectionAcquireInjectExceptions}) to apply different configurations to different containers.
 *
