...
/**
 * L1 chaos primitive: silently suppress the SOCKET_ACCEPT operation; callers receive null/false/no-op per operation semantics.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#SOCKET_ACCEPT
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.NETWORK, operationType = OperationType.SOCKET_ACCEPT)
