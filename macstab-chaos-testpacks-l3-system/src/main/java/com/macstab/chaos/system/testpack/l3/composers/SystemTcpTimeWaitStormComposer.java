 ...
 *
 * <p>Injects {@code ECONNREFUSED} on outbound {@code connect()} calls to reproduce the compound
 * failure profile of TCP TIME_WAIT ephemeral port exhaustion.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class SystemTcpTimeWaitStormComposer
    implements L3Composer<IncidentChaosSystemTcpTimeWaitStorm> {

  public SystemTcpTimeWaitStormComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosSystemTcpTimeWaitStorm ann) {
