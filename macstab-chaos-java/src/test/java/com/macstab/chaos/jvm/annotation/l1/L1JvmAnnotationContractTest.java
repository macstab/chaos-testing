...
@DisplayName("L1 JVM annotation contract")
class L1JvmAnnotationContractTest {

    static Stream<Arguments> allL1Annotations() throws Exception {
        List<Class<?>> result = new ArrayList<>();
        String rootPackage = "com.macstab.chaos.jvm.annotation.l1";
        String resourcePath = rootPackage.replace('.', '/');
        ClassLoader cl = L1JvmAnnotationContractTest.class.getClassLoader();
    ...
    void foundExpectedCount() throws Exception {
        ...
        assertThat(count).isGreaterThanOrEqualTo(130);
    }
}
