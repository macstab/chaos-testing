...
/**
 * Delays every libchaos-intercepted {@code waitpid} call by {@link #delayMs} milliseconds before
 ...
 *
 * <p><strong>What chaos this applies:</strong> every {@code waitpid} call intercepted by libchaos
 ...
 * applies to every capable container. Use the repeatable form ({@code @ChaosWaitpidLatencys}) to
