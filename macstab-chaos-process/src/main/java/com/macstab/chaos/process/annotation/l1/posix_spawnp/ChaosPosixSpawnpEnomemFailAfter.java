 ...
 * (selector = {@code POSIX_SPAWNP}, errno = {@code ENOMEM}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosPosixSpawnpEnomemFailAfter(successesBeforeFailure = 128)
 ...
 * {@code posix_spawnp} calls the application is expected to make before hitting the limit.
 ...
 * ({@code @ChaosPosixSpawnpEnomemFailAfter.Repeatable}) to apply different counters to different containers.
 *
