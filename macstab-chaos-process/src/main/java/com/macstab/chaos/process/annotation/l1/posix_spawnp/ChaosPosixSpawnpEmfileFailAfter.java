 ...
 * (selector = {@code POSIX_SPAWNP}, errno = {@code EMFILE}, effect = FAIL_AFTER) tuple.
 ...
 * ({@code @ChaosPosixSpawnpEmfileFailAfter.Repeatable}) to apply different counters to different containers.
 *
