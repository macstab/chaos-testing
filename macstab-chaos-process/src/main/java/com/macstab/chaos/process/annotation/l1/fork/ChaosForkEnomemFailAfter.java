 ...
 * @ChaosForkEnomemFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosForkEnomemFailAfters}) to bind different probabilities to
...
public @interface ChaosForkEnomemFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosForkEnomemFailAfter(id = "primary",  probability = 0.001)
   * @ChaosForkEnomemFailAfter(id = "replica",  probability = 0.01)
