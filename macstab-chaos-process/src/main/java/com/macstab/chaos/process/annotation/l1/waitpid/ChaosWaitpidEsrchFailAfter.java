 ...
 * (selector = {@code WAITPID}, errno = {@code ESRCH}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosWaitpidEsrchFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosWaitpidEsrchFailAfter.Repeatable}) to apply different counters to different containers.
 *
