...
/**
 * Injects {@code ENOENT} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code ENOENT} is a valid POSIX result of {@code wildcard}.
 *
 ...
 * @ChaosWildcardEnoent(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEnoents}) to bind different probabilities to
