...
/**
 * L1 chaos primitive: inject {@code EBADF} on every libchaos-memory-intercepted
 * {@code mmap(MAP_ANONYMOUS)} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> bad file descriptor — typical of fd lifecycle bugs and shared-fd races.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code EBADF} on {@code mmap(MAP_ANONYMOUS)}; {@code 1.0} produces
