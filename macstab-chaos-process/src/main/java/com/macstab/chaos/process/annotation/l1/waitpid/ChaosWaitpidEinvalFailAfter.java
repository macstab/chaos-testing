 ...
 * (selector = {@code WAITPID}, errno = {@code EINVAL}, effect = FAIL_AFTER) tuple.
 ...
 * ({@code @ChaosWaitpidEinvalFailAfter.Repeatable}) to apply different counters to different containers.
 *
