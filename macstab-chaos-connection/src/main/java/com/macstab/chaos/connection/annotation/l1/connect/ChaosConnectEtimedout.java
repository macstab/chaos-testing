...
/**
 * Injects {@code ETIMEDOUT} on every libchaos-intercepted {@code connect} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosConnectEtimedouts}) to bind different probabilities to
