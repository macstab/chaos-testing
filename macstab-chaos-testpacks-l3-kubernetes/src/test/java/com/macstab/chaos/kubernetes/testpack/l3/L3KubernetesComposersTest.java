...
class L3KubernetesComposersTest {
    ...
    void rollingUpdateRst_isRepeatable() {
        assertThat(IncidentChaosK8sRollingUpdateRst.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void dnsNdots5Storm_isRepeatable() {
        assertThat(IncidentChaosK8sDnsNdots5Storm.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void oomKillMidGc_isRepeatable() {
        assertThat(IncidentChaosK8sOomKillMidGc.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void sidecarShutdownRace_hasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosK8sSidecarShutdownRace.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void sidecarShutdownRace_isRepeatable() {
        assertThat(IncidentChaosK8sSidecarShutdownRace.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void cpuThrottleGcAmplification_hasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosK8sCpuThrottleGcAmplification.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void cpuThrottleGcAmplification_isRepeatable() {
        assertThat(IncidentChaosK8sCpuThrottleGcAmplification.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void allAnnotationsHaveIdAttribute() throws Exception {
        ...
        assertThat(IncidentChaosK8sCpuThrottleGcAmplification.class.getDeclaredMethod("id")).isNotNull();
    }
    ...
    void allComposerClassNamesReferenceCorrectPackage() {
        ...
        assertThat(IncidentChaosK8sSidecarShutdownRace.class.getAnnotation(ChaosL3.class).composer())
                .startsWith(expectedPackage);
        assertThat(IncidentChaosK8sCpuThrottleGcAmplification.class.getAnnotation(ChaosL3.class).composer())
                .startsWith(expectedPackage);
    }
}
