  ...
  static void removeAll(final GenericContainer<?> container, final List<Object> handles) {
    for (final Object h : handles) {
      try {
        ...
        } else if (h instanceof com.macstab.chaos.time.api.RuleHandle rh) {
          new LibchaosTransport(LibchaosLib.TIME).removeRules(container, rh.owner());
        } else if (h instanceof com.macstab.chaos.filesystem.api.RuleHandle rh) {
