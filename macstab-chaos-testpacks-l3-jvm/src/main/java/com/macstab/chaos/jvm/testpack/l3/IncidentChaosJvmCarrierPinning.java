...
/**
 * <h2>What this is</h2>
 * <p>Simulates JVM virtual thread carrier pinning: {@code synchronized} blocks pin carrier
 * threads, starving the carrier pool and preventing virtual threads from being scheduled. The
 * service appears to hang with zero errors, zero rejections, and zero warnings in the logs.
 *
 * <h2>Composed of</h2>
 * <ul>
 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>JDK 21+ services using virtual threads hang
 * completely; no exceptions are thrown; JFR VirtualThreadPinned events are the only observable
 * signal.
 *
...
@ChaosL3(composer = "com.macstab.chaos.jvm.testpack.l3.composers.JvmCarrierPinningComposer", severity = Severity.CRITICAL)
