 ...
 * (selector = {@code WAITPID}, errno = {@code ECHILD}, effect = FAIL_AFTER) tuple.
 ...
 * ({@code @ChaosWaitpidEchildFailAfter.Repeatable}) to apply different counters to different containers.
 *
