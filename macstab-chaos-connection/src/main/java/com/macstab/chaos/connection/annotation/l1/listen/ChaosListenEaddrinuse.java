...
/**
 * L1 chaos primitive: inject {@code EADDRINUSE} on every libchaos-net-intercepted
 * {@code listen} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> address already in use — port collision; typical of fast-restart bind races.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosListenEaddrinuse(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
 * <p><strong>Scope:</strong> applies to every {@code listen} call across all endpoints.
