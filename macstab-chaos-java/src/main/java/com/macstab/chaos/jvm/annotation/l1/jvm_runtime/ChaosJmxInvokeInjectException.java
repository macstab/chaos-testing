 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JMX_INVOKE
 ...
 * ({@code @ChaosJmxInvokeInjectExceptions}) to apply different configurations to different
 * containers.
 *
