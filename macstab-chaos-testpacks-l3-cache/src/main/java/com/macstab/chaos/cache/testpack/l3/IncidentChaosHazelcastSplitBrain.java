 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>Silent data loss on partition healing. No exception is
 * visible to the application; writes accepted during the split are silently dropped by the loser
 * side of the merge.
 *
 * <h2>Industry references</h2>
 * <p>Hazelcast split-brain merge policies are documented in the official Hazelcast reference manual.
 * Production incidents involving split-brain data loss have been reported across multiple cloud
 * environments where network ACL changes caused asymmetric partition events.
 *
 * <h2>Example</h2>
 * <pre>{@code
 * @AppContainer
...
@ChaosL3(composer = "com.macstab.chaos.cache.testpack.l3.composers.HazelcastSplitBrainComposer", severity = Severity.CRITICAL)
