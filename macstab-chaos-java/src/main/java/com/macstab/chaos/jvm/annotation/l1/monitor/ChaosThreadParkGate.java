...
/**
 * L1 chaos primitive: block the THREAD_PARK operation until released or the configured timeout elapses.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.MONITOR, operationType = OperationType.THREAD_PARK)
