...
class L3RedisComposersTest {
    ...
    void redisFailoverStormIsRepeatable() {
        assertThat(IncidentChaosRedisFailoverStorm.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void redisCacheAvalancheIsRepeatable() {
        assertThat(IncidentChaosRedisCacheAvalanche.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void redisClockDriftIsRepeatable() {
        assertThat(IncidentChaosRedisClockDrift.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void redisOomEvictionIsRepeatable() {
        assertThat(IncidentChaosRedisOomEviction.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void redisSlowlogIsRepeatable() {
        assertThat(IncidentChaosRedisSlowlog.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void redisNetworkFlapIsRepeatable() {
        assertThat(IncidentChaosRedisNetworkFlap.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
