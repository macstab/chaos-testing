...
/**
 * L1 chaos primitive: delay the DNS_RESOLVE operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.DNS, operationType = OperationType.DNS_RESOLVE)
