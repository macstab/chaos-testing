...
/**
 * Activates a self-driving JVM stressor that flood the ReferenceHandler thread's queue with
 * WeakReferences inside the target container's JVM for the duration of the test class or test
 * method.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor flood the ReferenceHandler thread's
 * queue with WeakReferences. The effect persists throughout the test and is not probabilistic — it
 ...
 * ({@code @ChaosReferenceQueueFloods}) to apply different stressor intensities to different
 * containers.
 *
