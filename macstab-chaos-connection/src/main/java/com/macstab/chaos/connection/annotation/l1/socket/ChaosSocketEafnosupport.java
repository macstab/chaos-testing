...
/**
 * L1 chaos primitive: inject {@code EAFNOSUPPORT} on every libchaos-net-intercepted
 * {@code socket} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> address family not supported — typical of IPv4/IPv6 misconfiguration.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosSocketEafnosupport(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
