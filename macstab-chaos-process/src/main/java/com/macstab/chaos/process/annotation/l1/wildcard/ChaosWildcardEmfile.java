...
/**
 * Injects {@code EMFILE} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code EMFILE} is a valid POSIX result of {@code wildcard}.
 *
