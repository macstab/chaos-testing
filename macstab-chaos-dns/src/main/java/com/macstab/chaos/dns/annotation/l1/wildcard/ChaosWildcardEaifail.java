...
/**
 * Injects {@code EAI_FAIL} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code EAI_FAIL} is a valid POSIX result of {@code wildcard}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEaifails}) to bind different probabilities
