 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the DNS_RESOLVE
 ...
 * ({@code @ChaosDnsResolveInjectExceptions}) to apply different configurations to different
 * containers.
 *
