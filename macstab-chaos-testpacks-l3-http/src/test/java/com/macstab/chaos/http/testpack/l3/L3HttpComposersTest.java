...
class L3HttpComposersTest {
  ...
  void httpCascadingTimeoutIsRepeatable() {
    assertThat(
            IncidentChaosHttpCascadingTimeout.class.isAnnotationPresent(
  ...
  void httpRetryAmplificationHasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosHttpRetryAmplification.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void httpRetryAmplificationIsRepeatable() {
    assertThat(
            IncidentChaosHttpRetryAmplification.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void httpPartialOutageIsRepeatable() {
    assertThat(
            IncidentChaosHttpPartialOutage.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void httpSslHandshakeStormHasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosHttpSslHandshakeStorm.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void httpSslHandshakeStormIsRepeatable() {
    assertThat(
            IncidentChaosHttpSslHandshakeStorm.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
