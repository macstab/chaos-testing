...
/**
 * L1 chaos primitive: inject {@code EHOSTUNREACH} on every libchaos-net-intercepted
 * {@code connect} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> host unreachable — ICMP unreachable response; typical of route-table flaps.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosConnectEhostunreach(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
