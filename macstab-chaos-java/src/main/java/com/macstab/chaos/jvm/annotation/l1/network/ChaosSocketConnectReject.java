 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the SOCKET_CONNECT operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
