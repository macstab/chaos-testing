 ...
 *
 * <p>Applies high RECV latency to simulate ISR replication lag and injects TimeoutException
 * at METHOD_EXIT to reproduce the compound failure profile of an unclean leader election
 * where a lagged broker is promoted, causing message loss and consumer timestamp regression.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class KafkaUncleanLeaderElectionComposer implements L3Composer<IncidentChaosKafkaUncleanLeaderElection> {

    public KafkaUncleanLeaderElectionComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosKafkaUncleanLeaderElection ann) {
        ...
        final String scenarioId = JvmPlanAccumulator.instance().mintScenarioId("KafkaUncleanLeaderElection");
