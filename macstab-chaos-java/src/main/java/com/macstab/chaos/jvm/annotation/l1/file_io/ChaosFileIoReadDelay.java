...
/**
 * L1 chaos primitive: delay the FILE_IO_READ operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#FILE_IO_READ
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.FILE_IO, operationType = OperationType.FILE_IO_READ)
