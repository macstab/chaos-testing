...
/**
 * L1 chaos primitive: delay the NATIVE_LIBRARY_LOAD operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#NATIVE_LIBRARY_LOAD
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.NATIVE_LIBRARY_LOAD)
