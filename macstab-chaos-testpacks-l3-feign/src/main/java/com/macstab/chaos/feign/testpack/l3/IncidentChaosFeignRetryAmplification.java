 ...
 * <h2>What this is</h2>
 *
 * <p>Simulates retry amplification caused by stacked retry policies: Feign's built-in retry (3
 ...
 *
 * <ul>
 *   <li>Connection: CONNECT → ECONNREFUSED at toxicity {@code toxicity} — triggers the brownout
 *       condition that activates both retry layers
 *   <li>JVM: IOException injected at METHOD_EXIT on class prefix {@code classPattern} — forces the
 *       Feign retry path to activate alongside Resilience4j retries
 * </ul>
 *
 * <h2>How bad it is</h2>
 *
 * <p>Severity: <strong>SEVERE</strong><br>
 * 9× upstream amplification during brownout can cascade and take down downstream services that were
 * otherwise healthy.
 *
...
@ChaosL3(
    composer = "com.macstab.chaos.feign.testpack.l3.composers.FeignRetryAmplificationComposer",
