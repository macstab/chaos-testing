...
/**
 * Injects {@code EAFNOSUPPORT} on every libchaos-intercepted {@code socket} call inside the target
 * container, making the call fail as if the kernel returned {@code EAFNOSUPPORT}.
 *
 ...
 * annotation class exists only because {@code EAFNOSUPPORT} is a valid POSIX result of {@code
 * socket}.
 *
 ...
 * interceptor returns {@code -1} and sets {@code errno = EAFNOSUPPORT} — from the application's
 * perspective this is indistinguishable from a real kernel-level failure. Specifically this
 * simulates: address family not supported — IPv4/IPv6 misconfiguration.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosSocketEafnosupports}) to bind different
