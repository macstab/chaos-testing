...
/**
 * Activates a self-driving JVM stressor that spawn N never-terminating threads inside the target
 * container's JVM for the duration of the test class or test method.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor spawn N never-terminating threads. The
 * effect persists throughout the test and is not probabilistic — it runs continuously at the
 * configured intensity until the rule is removed.
 *
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosThreadLeaks}) to
