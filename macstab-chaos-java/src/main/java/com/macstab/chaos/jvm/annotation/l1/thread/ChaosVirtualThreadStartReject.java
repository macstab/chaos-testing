...
/**
 * Reject the virtual_thread_start operation by throwing an appropriate exception for the operation type.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the VIRTUAL_THREAD_START operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
 ...
 * ({@code @ChaosVirtualThreadStartRejects}) to apply different configurations to different containers.
 *
