 ...
 */
public final class SpringStartupFailureComposer implements L3Composer<IncidentChaosSpringStartupFailure> {

    public SpringStartupFailureComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosSpringStartupFailure ann) {
    ...
    public List<String> describe(final IncidentChaosSpringStartupFailure ann) {
        return List.of(
                ...
                "jvm: ApplicationContextException on class prefix '" + ann.classPattern() + "' (METHOD_ENTER)",
