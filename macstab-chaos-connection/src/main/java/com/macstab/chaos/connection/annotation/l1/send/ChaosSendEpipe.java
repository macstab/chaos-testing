...
/**
 * L1 chaos primitive: inject {@code EPIPE} on every libchaos-net-intercepted
 * {@code send} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> broken pipe — write to closed peer; very common in disconnect scenarios.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
