 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the OBJECT_SERIALIZE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosObjectSerializeInjectExceptions}) to apply different configurations to different containers.
 *
