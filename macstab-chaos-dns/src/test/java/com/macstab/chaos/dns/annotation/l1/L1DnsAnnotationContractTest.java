...
@DisplayName("L1 DNS annotation contract")
class L1DnsAnnotationContractTest {

    static Stream<Arguments> allL1Annotations() throws Exception {
        List<Class<?>> result = new ArrayList<>();
        String rootPackage = "com.macstab.chaos.dns.annotation.l1";
        String resourcePath = rootPackage.replace('.', '/');
        ClassLoader cl = L1DnsAnnotationContractTest.class.getClassLoader();
    ...
    void foundExpectedCount() throws Exception {
        ...
        assertThat(count).isGreaterThanOrEqualTo(18);
    }
}
