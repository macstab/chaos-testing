 ...
 * named, compound production incidents observed in HTTP-based microservice architectures:
 * cascading timeouts, retry amplification storms, partial outages, and SSL handshake failures
 * under load.
 *
