...
/**
 * L1 chaos primitive: inject {@code ETIMEDOUT} on every libchaos-net-intercepted
 * {@code connect} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> connection / operation timeout — peer unresponsive or routing black-holed.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosConnectEtimedout(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
