...
/**
 * Injects {@code ENOMEM} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code ENOMEM} is a valid POSIX result of {@code wildcard}.
 *
 ...
 * @ChaosWildcardEnomem(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEnomems}) to bind different probabilities to
