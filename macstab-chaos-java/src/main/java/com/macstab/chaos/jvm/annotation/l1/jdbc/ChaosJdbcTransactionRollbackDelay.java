...
/**
 * Delay the jdbc_transaction_rollback operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the JDBC_TRANSACTION_ROLLBACK operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosJdbcTransactionRollbackDelays}) to apply different configurations to different containers.
 *
