...
/**
 * Delays every libchaos-intercepted {@code socket} call by {@link #delayMs} milliseconds before
 ...
 *
 * <p><strong>What chaos this applies:</strong> every {@code socket} call intercepted by libchaos
 ...
 * @ChaosSocketLatency(delayMs = 200)
 * class LatencyTest {
 *   @Test
 ...
 * applies to every capable container. Use the repeatable form ({@code @ChaosSocketLatencys}) to set
