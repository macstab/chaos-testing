 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>10–50x throughput drop once JIT is permanently
 * disabled; zero exceptions are thrown; the degradation accumulates over hours or days before
 * being noticed.
 *
 * <h2>Industry references</h2>
 * <p>JIT code cache exhaustion: the Atlassian Confluence CodeCache full incident (2019) caused
 * a complete service performance collapse with no alerts, no errors, and a gradual degradation
 * that looked like a memory leak in monitoring but had a clean heap.
 *
 * <h2>Example</h2>
 * <pre>{@code
 * @AppContainer
...
@ChaosL3(composer = "com.macstab.chaos.jvm.testpack.l3.composers.JvmCodeCacheFullComposer", severity = Severity.CRITICAL)
