 ...
 * @ChaosPosixSpawnpEmfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEmfileFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnpEmfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnpEmfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnpEmfileFailAfter(id = "replica",  probability = 0.01)
