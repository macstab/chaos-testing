 ...
 * (selector = {@code POSIX_SPAWN}, errno = {@code ENOENT}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosPosixSpawnEnoentFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosPosixSpawnEnoentFailAfter.Repeatable}) to apply different counters to different containers.
 *
