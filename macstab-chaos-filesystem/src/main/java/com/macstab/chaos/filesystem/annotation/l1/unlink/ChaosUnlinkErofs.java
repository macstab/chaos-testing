...
/**
 * L1 chaos primitive: inject {@code EROFS} on every libchaos-io-intercepted {@code unlink} syscall,
 * gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> read-only filesystem — typical of disk remounted ro
 * after fs errors.
 *
