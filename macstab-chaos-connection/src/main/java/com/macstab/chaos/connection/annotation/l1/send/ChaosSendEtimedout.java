...
/**
 * Injects {@code ETIMEDOUT} on every libchaos-intercepted {@code send} call inside the target
 ...
 * exists only because {@code ETIMEDOUT} is a valid POSIX result of {@code send}.
 *
