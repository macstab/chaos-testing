...
/**
 * L1 chaos primitive: inject {@code EIO} on every libchaos-io-intercepted
 * {@code fdatasync} syscall, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> I/O error — typical of disk failures, bad sectors, or storage backend errors.
 *
