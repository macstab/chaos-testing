 ...
 * pre-filled to near capacity while a sustained allocation rate prevents G1 from completing
 * normal evacuation, forcing a full stop-the-world GC with 5–30x longer pause times. An OOM
 * injection ensures the application observes the failure.
 *
 * <h2>Composed of</h2>
 * <ul>
 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>GC pause 5–30x longer than normal; liveness probes
 * kill the pod mid-GC; rolling deploy stalls with pods unable to start up cleanly.
 *
...
@ChaosL3(composer = "com.macstab.chaos.jvm.testpack.l3.composers.JvmG1ToSpaceExhaustedComposer", severity = Severity.CRITICAL)
