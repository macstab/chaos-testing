...
/**
 * Activates a self-driving JVM stressor that plant large ThreadLocal entries in pool threads inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor plant large ThreadLocal entries in pool threads. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosThreadLocalLeaks}) to
