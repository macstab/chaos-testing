...
/**
 * Injects {@code EIO} on every libchaos-intercepted {@code close} call inside the target container,
 ...
 * exists only because {@code EIO} is a valid POSIX result of {@code close}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code close} call that the libchaos
 ...
 * class. Use the repeatable form ({@code @ChaosCloseEios}) to bind different probabilities to
