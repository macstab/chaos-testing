...
/**
 * Injects {@code EPERM} on every libchaos-intercepted {@code clock gettime} call inside the target
 ...
 * exists only because {@code EPERM} is a valid POSIX result of {@code clock gettime}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosClockGettimeEperms}) to bind different probabilities
