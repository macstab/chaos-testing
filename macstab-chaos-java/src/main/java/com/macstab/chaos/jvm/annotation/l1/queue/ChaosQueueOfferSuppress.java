...
/**
 * L1 chaos primitive: silently suppress the QUEUE_OFFER operation; callers receive null/false/no-op per operation semantics.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.QUEUE, operationType = OperationType.QUEUE_OFFER)
