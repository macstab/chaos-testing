 ...
 * (selector = {@code POSIX_SPAWN}, errno = {@code EMFILE}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosPosixSpawnEmfileFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosPosixSpawnEmfileFailAfter.Repeatable}) to apply different counters to different containers.
 *
