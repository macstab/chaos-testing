 ...
 * accumulation: slow fsync and write operations on the database data directory combine with
 * network receive latency to model an overloaded storage subsystem during heavy write workloads.
 *
 * <h2>Composed of</h2>
 * <ul>
 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Severe</strong><br>Commit latency spikes cause application-level timeouts,
 * replica lag accumulates, and read replicas fall progressively behind; operator intervention to
 * tune or replace the storage subsystem is required.
 *
...
@ChaosL3(composer = "com.macstab.chaos.jdbc.testpack.l3.composers.JdbcWalPressureComposer", severity = Severity.SEVERE)
