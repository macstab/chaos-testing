 ...
 * = {@code POSIX_SPAWN}, errno = {@code ENOENT}, effect = FAIL_AFTER) tuple. FAIL_AFTER is the
 ...
 * ({@code @ChaosPosixSpawnEnoentFailAfter.Repeatable}) to apply different counters to different
 * containers.
 *
