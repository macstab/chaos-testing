...
/**
 * Injects {@code ENOMEM} on every libchaos-memory-intercepted {@code mmap(MAP_ANONYMOUS)} call
 * inside the target container, making the call fail as if the kernel returned {@code ENOMEM}.
 *
 * <p><strong>What this annotation is:</strong> an L1 chaos primitive — the smallest declarative
 * chaos unit. It encodes exactly one (selector = {@code MMAP_ANON}, errno = {@code ENOMEM}) pair.
 ...
 * the test class. Use the repeatable form ({@code @ChaosMmapAnonEnomems}) to bind different
