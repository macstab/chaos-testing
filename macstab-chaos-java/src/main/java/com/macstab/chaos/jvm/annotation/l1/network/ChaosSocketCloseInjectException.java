 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the SOCKET_CLOSE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosSocketCloseInjectExceptions}) to apply different configurations to different containers.
 *
