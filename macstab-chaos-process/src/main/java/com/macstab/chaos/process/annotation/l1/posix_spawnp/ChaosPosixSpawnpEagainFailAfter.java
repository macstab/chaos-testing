...
/**
 * Injects {@code ERRNO} on every libchaos-intercepted {@code posix spawnp} call inside
 ...
 * @ChaosPosixSpawnpEagainFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEagainFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnpEagainFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnpEagainFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnpEagainFailAfter(id = "replica",  probability = 0.01)
