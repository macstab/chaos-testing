...
/**
 * Injects {@code EFAULT} on every libchaos-memory-intercepted {@code mmap (file-backed)} call
 * inside the target container, making the call fail as if the kernel returned {@code EFAULT}.
 *
 * <p><strong>What this annotation is:</strong> an L1 chaos primitive — the smallest declarative
 * chaos unit. It encodes exactly one (selector = {@code MMAP_FILE}, errno = {@code EFAULT}) pair.
 ...
 * the test class. Use the repeatable form ({@code @ChaosMmapFileEfaults}) to bind different
