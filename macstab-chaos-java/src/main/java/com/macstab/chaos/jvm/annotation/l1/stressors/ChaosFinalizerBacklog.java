...
/**
 * Activates a self-driving JVM stressor that slow finalizers back up the GC finalizer thread queue inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor slow finalizers back up the GC finalizer thread queue. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosFinalizerBacklogs}) to
