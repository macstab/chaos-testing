 ...
 */
public final class HazelcastSplitBrainComposer
    implements L3Composer<IncidentChaosHazelcastSplitBrain> {

  public HazelcastSplitBrainComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosHazelcastSplitBrain ann) {
