...
/**
 * L1 chaos primitive: inject {@code ENOSYS} on every libchaos-memory-intercepted
 * {@code madvise} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> function not implemented — kernel lacks the operation (e.g. unsupported madvise advice).
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code ENOSYS} on {@code madvise}; {@code 1.0} produces
