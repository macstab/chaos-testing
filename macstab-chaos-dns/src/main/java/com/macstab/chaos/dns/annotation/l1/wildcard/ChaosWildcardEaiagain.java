...
/**
 * L1 chaos primitive: inject {@code EAI_AGAIN} on every libchaos-dns-intercepted
 * {@code every resolver} call inside the container.
 *
 * <p><strong>What this simulates:</strong> temporary resolution failure — DNS server unreachable or timing out; canary for retry behaviour.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
