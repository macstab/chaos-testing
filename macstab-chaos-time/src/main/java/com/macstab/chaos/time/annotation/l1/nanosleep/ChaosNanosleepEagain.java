...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code nanosleep} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosNanosleepEagains}) to bind different probabilities to
