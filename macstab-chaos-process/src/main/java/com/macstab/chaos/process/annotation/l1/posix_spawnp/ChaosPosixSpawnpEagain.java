...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code posix spawnp} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEagains}) to bind different probabilities to
