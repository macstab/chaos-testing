 ...
 * <h2>What this is</h2>
 *
 * <p>Simulates a Redis Sentinel election storm: replica promotion races with an in-flight NTP clock
 * correction, causing clients to see connection-refused errors, transient DNS resolution failures,
 * and a wall-clock jump that invalidates Sentinel quorum timers simultaneously.
 *
 * <h2>Composed of</h2>
 *
 * <ul>
 ...
 * All clients lose connectivity for the duration of the election window; retry storms and
 * split-brain windows are common side effects.
 *
