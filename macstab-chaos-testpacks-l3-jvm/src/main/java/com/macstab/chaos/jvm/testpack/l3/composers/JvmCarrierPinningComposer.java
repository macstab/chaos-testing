...
public final class JvmCarrierPinningComposer implements L3Composer<IncidentChaosJvmCarrierPinning> {
  ...
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosJvmCarrierPinning ann) {
        ...
        ChaosScenario.builder(id)
            ...
            .effect(
                ChaosEffect.virtualThreadCarrierPinning(
                    ann.pinnedThreadCount(), Duration.ofMillis(ann.pinDurationMs())))
  ...
  public List<String> describe(final IncidentChaosJvmCarrierPinning ann) {
    return List.of(
        ...
        "jvm: VirtualThreadCarrierPinning "
            + ann.pinnedThreadCount()
            + " carriers pinned for "
            + ann.pinDurationMs()
            + "ms each",
