...
class ToxiproxyApiClientImplTest {
  ...
  class IsApiReadyTests {
    ...
    void shouldReturnTrue_whenApiResponds() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult1);
    ...
    void shouldReturnFalse_whenApiReturnsError() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult2);
  ...
  class ProxyExistsTests {
    ...
    void shouldReturnTrue_whenProxyExists() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult3);
    ...
    void shouldReturnFalse_whenProxyDoesNotExist() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult4);
  ...
  class CreateProxyTests {
    ...
    void shouldCreateProxy_successfully() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult5);
    ...
    void shouldThrowIOException_whenCreationFails() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult6);
  ...
  class DeleteProxyTests {
    ...
    void shouldDeleteProxy_successfully() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult7);
    ...
    void shouldThrowIOException_whenDeletionFails() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult8);
  ...
  class ToxicExistsTests {
    ...
    void shouldReturnTrue_whenToxicExistsInList() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult9);
    ...
    void shouldReturnFalse_whenToxicNotInList() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult10);
  ...
  class AddToxicTests {
    ...
    void shouldAddToxic_successfully() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult11);

      apiClient.addToxic(ctx, "redis", "latency", "latency", "{\"latency\":1000}", 1.0);
    ...
    void shouldThrow_whenToxicityBelowZero() {
      assertThatIllegalArgumentException()
          .isThrownBy(() -> apiClient.addToxic(ctx, "redis", "latency", "latency", "{}", -0.1))
    ...
    void shouldThrow_whenToxicityAboveOne() {
      assertThatIllegalArgumentException()
          .isThrownBy(() -> apiClient.addToxic(ctx, "redis", "latency", "latency", "{}", 1.1))
          .withMessageContaining("toxicity must be in [0.0, 1.0]");
    }
    ...
    void shouldThrowNpe_whenToxicNameIsNull() {
      assertThatNullPointerException()
          .isThrownBy(() -> apiClient.addToxic(ctx, "redis", null, "latency", "{}", 1.0))
          .withMessage("toxicName must not be null");
    }
    ...
    void shouldThrowNpe_whenToxicTypeIsNull() {
      assertThatNullPointerException()
          .isThrownBy(() -> apiClient.addToxic(ctx, "redis", "latency", null, "{}", 1.0))
    ...
    void shouldThrowNpe_whenAttributesIsNull() {
      assertThatNullPointerException()
          .isThrownBy(() -> apiClient.addToxic(ctx, "redis", "latency", "latency", null, 1.0))
  ...
  class DeleteToxicTests {
    ...
    void shouldDeleteToxic_successfully() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult12);
    ...
    void shouldThrowIOException_whenDeletionFails() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult13);
  ...
  class ListToxicsTests {
    ...
    void shouldParseToxicNames_fromJsonResponse() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult14);
    ...
    void shouldReturnEmptyList_whenNoToxics() throws Exception {
      ...
      when(shell.exec(eq(container), anyString())).thenReturn(execResult15);
