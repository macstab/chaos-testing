...
/**
 * L1 chaos primitive: inject {@code EOPNOTSUPP} on every libchaos-net-intercepted
 * {@code listen} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> operation not supported on socket — typical of UDP socket listen() etc..
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosListenEopnotsupp(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
