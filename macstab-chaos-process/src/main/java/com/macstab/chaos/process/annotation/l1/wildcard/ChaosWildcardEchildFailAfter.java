 ...
 * (selector = {@code WILDCARD}, errno = {@code ECHILD}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = ECHILD}, regardless of real
 ...
 * @ChaosWildcardEchildFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosWildcardEchildFailAfter.Repeatable}) to apply different counters to different containers.
 *
