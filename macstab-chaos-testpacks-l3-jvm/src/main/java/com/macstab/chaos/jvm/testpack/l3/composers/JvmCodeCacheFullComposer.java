 ...
 *
 * <p>Applies a CodeCachePressure stressor to reproduce the compound failure profile of JIT
 * code cache exhaustion causing permanent interpreter fallback and throughput collapse.
 *
...
public final class JvmCodeCacheFullComposer implements L3Composer<IncidentChaosJvmCodeCacheFull> {
    ...
    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosJvmCodeCacheFull ann) {
    ...
    public List<String> describe(final IncidentChaosJvmCodeCacheFull ann) {
        return List.of(
                ...
                "jvm: CodeCachePressure " + ann.classCount() + " classes × " + ann.methodsPerClass() + " methods (JIT-compiled 15,000×)",
