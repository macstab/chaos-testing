...
/**
 * Injects {@code EINTR} on every libchaos-intercepted {@code clock gettime} call inside
 ...
 * @ChaosClockGettimeEintr(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosClockGettimeEintrs}) to bind different probabilities to
