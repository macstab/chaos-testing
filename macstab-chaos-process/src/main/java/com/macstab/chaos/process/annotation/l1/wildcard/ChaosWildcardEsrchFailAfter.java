 ...
 * @ChaosWildcardEsrchFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEsrchFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEsrchFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEsrchFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEsrchFailAfter(id = "replica",  probability = 0.01)
