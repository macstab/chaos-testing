...
/**
 * Delay the socket_write operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the SOCKET_WRITE operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosSocketWriteDelays}) to apply different configurations to different containers.
 *
