...
/**
 * Reject the nio_channel_connect operation by throwing an appropriate exception for the operation type.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the NIO_CHANNEL_CONNECT operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
 ...
 * ({@code @ChaosNioChannelConnectRejects}) to apply different configurations to different containers.
 *
