 ...
 * update: old pod IPs stay in iptables rules for ~30 seconds after the pod terminates, causing
 * TCP RST on all in-flight requests that were routed to the terminating pod.
 *
 * <h2>Composed of</h2>
 * <ul>
 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>73% of Slack production incidents originate from
 * deploys; iptables rules propagate with approximately 30 seconds of lag, meaning every rolling
 * deploy is a silent RST window.
 *
 * <h2>Industry references</h2>
 * <p>Slack engineering blog: 73% of incidents traced to deploy events. Kubernetes networking
 * documentation acknowledges iptables propagation lag as a known source of connection resets
...
@ChaosL3(composer = "com.macstab.chaos.kubernetes.testpack.l3.composers.K8sRollingUpdateRstComposer", severity = Severity.CRITICAL)
