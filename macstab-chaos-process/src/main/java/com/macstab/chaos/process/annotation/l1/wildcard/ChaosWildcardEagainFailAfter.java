 ...
 * (selector = {@code WILDCARD}, errno = {@code EAGAIN}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = EAGAIN}, regardless of real
 ...
 * ({@code @ChaosWildcardEagainFailAfter.Repeatable}) to apply different counters to different containers.
 *
