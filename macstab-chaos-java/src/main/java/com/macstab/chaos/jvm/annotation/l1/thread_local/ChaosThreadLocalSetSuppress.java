...
/**
 * L1 chaos primitive: silently suppress the THREAD_LOCAL_SET operation; callers receive null/false/no-op per operation semantics.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#THREAD_LOCAL_SET
