 ...
 * @ChaosExecveatEnfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosExecveatEnfileFailAfters}) to bind different probabilities to
...
public @interface ChaosExecveatEnfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosExecveatEnfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosExecveatEnfileFailAfter(id = "replica",  probability = 0.01)
