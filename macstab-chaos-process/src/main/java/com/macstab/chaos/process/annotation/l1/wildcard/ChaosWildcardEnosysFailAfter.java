 ...
 * @ChaosWildcardEnosysFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEnosysFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEnosysFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEnosysFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEnosysFailAfter(id = "replica",  probability = 0.01)
