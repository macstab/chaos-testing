 ...
 * @ChaosPthreadCreateEbusyFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPthreadCreateEbusyFailAfters}) to bind different probabilities to
...
public @interface ChaosPthreadCreateEbusyFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPthreadCreateEbusyFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPthreadCreateEbusyFailAfter(id = "replica",  probability = 0.01)
