...
/**
 * Activates a self-driving JVM stressor that spawn N never-terminating threads inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor spawn N never-terminating threads. The effect persists
