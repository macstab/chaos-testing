...
/**
 * L1 chaos primitive: inject {@code ENFILE} on every libchaos-memory-intercepted
 * {@code mmap(MAP_ANONYMOUS)} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> system-wide file-descriptor limit reached — typical of host-side fd exhaustion incidents.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code ENFILE} on {@code mmap(MAP_ANONYMOUS)}; {@code 1.0} produces
