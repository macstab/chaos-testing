...
/**
 * Activates a self-driving JVM stressor that sustain a target allocation rate to stress the GC inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor sustain a target allocation rate to stress the GC. The effect persists
