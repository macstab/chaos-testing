...
/**
 * Injects {@code EMFILE} on every libchaos-intercepted {@code execveat} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosExecveatEmfiles}) to bind different probabilities to
