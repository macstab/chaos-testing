...
/**
 * Injects {@code EAI_MEMORY} on every libchaos-intercepted {@code forward} call inside the target
 ...
 * exists only because {@code EAI_MEMORY} is a valid POSIX result of {@code forward}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosForwardEaimemorys}) to bind different probabilities
