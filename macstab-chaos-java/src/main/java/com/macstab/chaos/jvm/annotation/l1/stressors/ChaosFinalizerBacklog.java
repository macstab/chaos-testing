...
/**
 * Activates a self-driving JVM stressor that slow finalizers back up the GC finalizer thread queue
 * inside the target container's JVM for the duration of the test class or test method.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor slow finalizers back up the GC
 * finalizer thread queue. The effect persists throughout the test and is not probabilistic — it
 ...
 * ({@code @ChaosFinalizerBacklogs}) to apply different stressor intensities to different
 * containers.
 *
