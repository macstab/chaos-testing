 ...
 * @ChaosPosixSpawnpEnfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnfileFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnpEnfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnpEnfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnpEnfileFailAfter(id = "replica",  probability = 0.01)
