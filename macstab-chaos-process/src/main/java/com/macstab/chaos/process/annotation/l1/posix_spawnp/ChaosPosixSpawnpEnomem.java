...
/**
 * Injects {@code ENOMEM} on every libchaos-intercepted {@code posix spawnp} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnomems}) to bind different probabilities to
