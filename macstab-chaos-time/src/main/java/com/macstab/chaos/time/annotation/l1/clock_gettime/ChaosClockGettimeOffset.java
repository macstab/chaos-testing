...
/**
 * Injects {@code ERRNO} on every libchaos-intercepted {@code clock gettime} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosClockGettimeOffsets}) to bind different probabilities to
