...
/**
 * Injects {@code ERRNO} on every libchaos-intercepted {@code read} call inside the target
 ...
 * exists only because {@code ERRNO} is a valid POSIX result of {@code read}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosReadCorrupts}) to bind different probabilities to
