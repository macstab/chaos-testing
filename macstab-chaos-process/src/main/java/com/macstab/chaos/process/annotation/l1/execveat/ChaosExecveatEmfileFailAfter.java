 ...
 * @ChaosExecveatEmfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosExecveatEmfileFailAfters}) to bind different probabilities to
...
public @interface ChaosExecveatEmfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosExecveatEmfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosExecveatEmfileFailAfter(id = "replica",  probability = 0.01)
