...
/**
 * Throw the configured exception at the class_load call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the CLASS_LOAD call site inside the JVM of the target container.
 ...
 * ({@code @ChaosClassLoadInjectExceptions}) to apply different configurations to different containers.
 *
