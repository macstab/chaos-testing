 ...
 * @ChaosPosixSpawnEagainFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEagainFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnEagainFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnEagainFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnEagainFailAfter(id = "replica",  probability = 0.01)
