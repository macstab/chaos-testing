...
/**
 * L1 chaos primitive: silently suppress the SYSTEM_GC_REQUEST operation; callers receive null/false/no-op per operation semantics.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.SYSTEM_GC_REQUEST)
