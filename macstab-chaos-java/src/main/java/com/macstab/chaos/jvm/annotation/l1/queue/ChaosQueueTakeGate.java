...
/**
 * L1 chaos primitive: block the QUEUE_TAKE operation until released or the configured timeout elapses.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.QUEUE, operationType = OperationType.QUEUE_TAKE)
