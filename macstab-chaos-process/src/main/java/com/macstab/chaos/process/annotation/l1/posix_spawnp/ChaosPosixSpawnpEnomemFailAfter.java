 ...
 * @ChaosPosixSpawnpEnomemFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnomemFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnpEnomemFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnpEnomemFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnpEnomemFailAfter(id = "replica",  probability = 0.01)
