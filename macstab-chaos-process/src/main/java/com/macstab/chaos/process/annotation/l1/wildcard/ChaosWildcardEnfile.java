...
/**
 * Injects {@code ENFILE} on every libchaos-intercepted {@code wildcard} call inside
 ...
 * @ChaosWildcardEnfile(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEnfiles}) to bind different probabilities to
