...
/**
 * Block the monitor_enter operation until released or the configured timeout elapses.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> block the MONITOR_ENTER operation until released or
 * the configured timeout elapses inside the JVM of the target container. The effect fires on every
 ...
 * ({@code @ChaosMonitorEnterGates}) to apply different configurations to different containers.
 *
