...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code posix spawn} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEagains}) to bind different probabilities to
