...
/**
 * Throw the configured exception at the nio_channel_read call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the NIO_CHANNEL_READ call site inside the JVM of the target container.
 ...
 * ({@code @ChaosNioChannelReadInjectExceptions}) to apply different configurations to different containers.
 *
