...
/**
 * L1 chaos primitive: inject {@code EACCES} on every libchaos-memory-intercepted {@code mmap} call
 * inside the container, gated by {@link #probability}.
 *
 ...
 * production rates for {@code EACCES} on {@code mmap}; {@code 1.0} produces ungrokable failures
