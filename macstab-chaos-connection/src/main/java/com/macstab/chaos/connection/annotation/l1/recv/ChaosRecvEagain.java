...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code recv} call inside the target
 ...
 * exists only because {@code EAGAIN} is a valid POSIX result of {@code recv}.
 *
 ...
 * @ChaosRecvEagain(toxicity = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosRecvEagains}) to bind different probabilities to
