...
@DisplayName("L1 Memory annotation contract")
class L1MemoryAnnotationContractTest {

    static Stream<Arguments> allL1Annotations() throws Exception {
        List<Class<?>> result = new ArrayList<>();
        String rootPackage = "com.macstab.chaos.memory.annotation.l1";
        String resourcePath = rootPackage.replace('.', '/');
        ClassLoader cl = L1MemoryAnnotationContractTest.class.getClassLoader();
