...
/**
 * Reject the shutdown_hook_register operation by throwing an appropriate exception for the operation type.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the SHUTDOWN_HOOK_REGISTER operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
 ...
 * ({@code @ChaosShutdownHookRegisterRejects}) to apply different configurations to different containers.
 *
