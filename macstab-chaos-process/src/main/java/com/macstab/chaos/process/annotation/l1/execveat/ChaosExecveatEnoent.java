...
/**
 * Injects {@code ENOENT} on every libchaos-intercepted {@code execveat} call inside the target
 ...
 * exists only because {@code ENOENT} is a valid POSIX result of {@code execveat}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosExecveatEnoents}) to bind different probabilities to
