 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Severe</strong><br>Heap is completely clean; the pod responds normally
 * to liveness probes; every new NIO, Netty, or gRPC operation that requires a direct buffer
 * throws {@code OutOfMemoryError: Direct buffer memory}.
 *
...
@ChaosL3(composer = "com.macstab.chaos.jvm.testpack.l3.composers.JvmDirectMemoryLeakComposer", severity = Severity.SEVERE)
