...
/**
 * L1 chaos primitive: delay the OBJECT_SERIALIZE operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#OBJECT_SERIALIZE
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.OBJECT_SERIALIZE)
