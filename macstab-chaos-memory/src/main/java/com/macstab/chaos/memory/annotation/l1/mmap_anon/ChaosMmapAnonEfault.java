...
/**
 * L1 chaos primitive: inject {@code EFAULT} on every libchaos-memory-intercepted
 * {@code mmap(MAP_ANONYMOUS)} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> bad address — typical of unhandled SIGSEGV-adjacent edge cases in JIT or native code.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code EFAULT} on {@code mmap(MAP_ANONYMOUS)}; {@code 1.0} produces
