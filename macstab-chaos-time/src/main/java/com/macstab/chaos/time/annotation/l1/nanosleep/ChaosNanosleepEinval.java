...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code nanosleep} call inside the target
 ...
 * exists only because {@code EINVAL} is a valid POSIX result of {@code nanosleep}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosNanosleepEinvals}) to bind different probabilities
