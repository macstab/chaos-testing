...
/**
 * Reject the executor_shutdown operation by throwing an appropriate exception for the operation type.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the EXECUTOR_SHUTDOWN operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
 ...
 * ({@code @ChaosExecutorShutdownRejects}) to apply different configurations to different containers.
 *
