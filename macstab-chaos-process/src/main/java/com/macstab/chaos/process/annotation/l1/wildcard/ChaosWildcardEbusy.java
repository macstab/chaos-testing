...
/**
 * Injects {@code EBUSY} on every libchaos-intercepted {@code wildcard} call inside
 ...
 * @ChaosWildcardEbusy(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEbusys}) to bind different probabilities to
