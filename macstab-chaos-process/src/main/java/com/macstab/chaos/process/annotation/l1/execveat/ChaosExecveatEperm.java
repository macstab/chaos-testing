...
/**
 * Injects {@code EPERM} on every libchaos-intercepted {@code execveat} call inside the target
 ...
 * exists only because {@code EPERM} is a valid POSIX result of {@code execveat}.
 *
