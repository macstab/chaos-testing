...
/**
 * Throw the configured exception at the http_client_send_async call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the HTTP_CLIENT_SEND_ASYNC call site inside the JVM of the target container.
 ...
 * ({@code @ChaosHttpClientSendAsyncInjectExceptions}) to apply different configurations to different containers.
 *
