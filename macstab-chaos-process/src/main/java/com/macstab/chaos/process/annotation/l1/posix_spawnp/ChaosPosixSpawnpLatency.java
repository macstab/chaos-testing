...
/**
 * Delays every libchaos-intercepted {@code posix spawnp} call by {@link #delayMs} milliseconds
 ...
 *
 * <p><strong>What chaos this applies:</strong> every {@code posix spawnp} call intercepted by
 ...
 * @ChaosPosixSpawnpLatency(delayMs = 200)
 * class LatencyTest {
 *   @Test
 ...
 * applies to every capable container. Use the repeatable form ({@code @ChaosPosixSpawnpLatencys})
