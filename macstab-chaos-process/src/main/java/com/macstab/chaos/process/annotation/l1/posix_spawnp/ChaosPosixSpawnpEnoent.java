...
/**
 * Injects {@code ENOENT} on every libchaos-intercepted {@code posix spawnp} call inside the target
 ...
 * exists only because {@code ENOENT} is a valid POSIX result of {@code posix spawnp}.
 *
 ...
 * @ChaosPosixSpawnpEnoent(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnoents}) to bind different probabilities
