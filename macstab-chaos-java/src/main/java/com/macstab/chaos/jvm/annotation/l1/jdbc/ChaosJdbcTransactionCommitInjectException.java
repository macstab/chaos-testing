 ...
 * JDBC_TRANSACTION_COMMIT call site inside the JVM of the target container. The effect fires on
 ...
 * ({@code @ChaosJdbcTransactionCommitInjectExceptions}) to apply different configurations to
