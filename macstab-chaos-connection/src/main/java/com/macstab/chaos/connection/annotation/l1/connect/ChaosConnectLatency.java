...
/**
 * Delays every libchaos-intercepted {@code connect} call by {@link #delayMs} milliseconds before
 ...
 *
 * <p><strong>What chaos this applies:</strong> every {@code connect} call intercepted by libchaos
 ...
 * @ChaosConnectLatency(delayMs = 200)
 * class LatencyTest {
 *   @Test
 ...
 * applies to every capable container. Use the repeatable form ({@code @ChaosConnectLatencys}) to
