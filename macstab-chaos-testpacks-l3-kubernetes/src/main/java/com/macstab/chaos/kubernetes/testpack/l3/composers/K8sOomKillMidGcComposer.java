 ...
 *
 * <p>Combines an OOM-kill stressor with a JVM-level OutOfMemoryError injection to reproduce
 * the compound failure profile of a cgroup RSS breach during a G1 heap evacuation pause.
 *
...
public final class K8sOomKillMidGcComposer implements L3Composer<IncidentChaosK8sOomKillMidGc> {
    ...
    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosK8sOomKillMidGc ann) {
