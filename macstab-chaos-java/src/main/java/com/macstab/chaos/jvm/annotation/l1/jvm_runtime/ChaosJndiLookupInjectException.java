 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JNDI_LOOKUP
 ...
 * ({@code @ChaosJndiLookupInjectExceptions}) to apply different configurations to different
 * containers.
 *
