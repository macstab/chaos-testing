...
/**
 * L1 chaos primitive: delay the JDBC_PREPARED_STATEMENT operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#JDBC_PREPARED_STATEMENT
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JDBC, operationType = OperationType.JDBC_PREPARED_STATEMENT)
