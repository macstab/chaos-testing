 ...
 * @ChaosWildcardEpermFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEpermFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEpermFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEpermFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEpermFailAfter(id = "replica",  probability = 0.01)
