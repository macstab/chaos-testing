 ...
 *
 * <p><strong>What chaos this applies:</strong> block the MONITOR_ENTER operation until released or the configured timeout elapses inside the JVM of the target container.
