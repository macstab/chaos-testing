...
/**
 * Lets the first {@link #successesBeforeFailure} libchaos-intercepted {@code fork} calls
 ...
 * (selector = {@code FORK}, errno = {@code ENOMEM}, effect = FAIL_AFTER) tuple.
 ...
 * {@code fork} calls. After {@link #successesBeforeFailure} successes the counter trips and
 ...
 * @ChaosForkEnomemFailAfter(successesBeforeFailure = 128)
 ...
 * {@code fork} calls the application is expected to make before hitting the limit.
 ...
 * ({@code @ChaosForkEnomemFailAfter.Repeatable}) to apply different counters to different containers.
 *
