...
/**
 * L1 chaos primitive: inject {@code EDQUOT} on every libchaos-io-intercepted
 * {@code allocate} syscall, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> user/group disk quota exceeded — typical of multi-tenant filesystem environments.
 *
