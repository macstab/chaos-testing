...
/**
 * Activates a self-driving JVM stressor that intern many strings to exhaust the JVM string table
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor intern many strings to exhaust the JVM
 * string table. The effect persists throughout the test and is not probabilistic — it runs
 ...
 * ({@code @ChaosStringInternPressures}) to apply different stressor intensities to different
 * containers.
 *
