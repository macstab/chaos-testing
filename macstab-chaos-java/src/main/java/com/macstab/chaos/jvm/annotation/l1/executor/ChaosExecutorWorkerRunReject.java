...
/**
 * Reject the executor_worker_run operation by throwing an appropriate exception for the operation type.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> reject the EXECUTOR_WORKER_RUN operation by throwing an appropriate exception for the operation type inside the JVM of the target container.
 ...
 * ({@code @ChaosExecutorWorkerRunRejects}) to apply different configurations to different containers.
 *
