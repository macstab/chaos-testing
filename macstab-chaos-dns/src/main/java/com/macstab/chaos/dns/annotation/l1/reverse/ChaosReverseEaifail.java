...
/**
 * Injects {@code EAI_FAIL} on every libchaos-intercepted {@code reverse} call inside
 ...
 * @ChaosReverseEaifail(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosReverseEaifails}) to bind different probabilities to
