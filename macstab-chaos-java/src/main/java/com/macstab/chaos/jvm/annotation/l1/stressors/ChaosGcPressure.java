...
/**
 * Activates a self-driving JVM stressor that sustain a target allocation rate to stress the GC
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor sustain a target allocation rate to
 * stress the GC. The effect persists throughout the test and is not probabilistic — it runs
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosGcPressures}) to
