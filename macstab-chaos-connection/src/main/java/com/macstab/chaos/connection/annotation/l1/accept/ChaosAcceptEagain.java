...
/**
 * L1 chaos primitive: inject {@code EAGAIN} on every libchaos-net-intercepted
 * {@code accept} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> resource temporarily unavailable — non-blocking socket would block; canary for backpressure handling.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosAcceptEagain(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
