 ...
 * @ChaosWildcardEnoentFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEnoentFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEnoentFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEnoentFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEnoentFailAfter(id = "replica",  probability = 0.01)
