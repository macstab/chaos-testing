...
/**
 * Activates a self-driving JVM stressor that N threads compete for a single lock with long hold times inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor N threads compete for a single lock with long hold times. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosMonitorContentions}) to
