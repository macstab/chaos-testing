...
/**
 * L1 chaos primitive: inject {@code EINVAL} on every libchaos-time-intercepted
 * {@code clock_gettime} call, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> invalid argument — bad clock id / timespec; the universal canary errno.
 *
