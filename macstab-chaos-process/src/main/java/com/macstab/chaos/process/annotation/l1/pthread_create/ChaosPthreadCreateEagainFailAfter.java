 ...
 * @ChaosPthreadCreateEagainFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPthreadCreateEagainFailAfters}) to bind different probabilities to
...
public @interface ChaosPthreadCreateEagainFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPthreadCreateEagainFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPthreadCreateEagainFailAfter(id = "replica",  probability = 0.01)
