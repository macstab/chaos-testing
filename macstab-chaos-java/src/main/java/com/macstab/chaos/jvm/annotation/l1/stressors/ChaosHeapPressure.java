...
/**
 * Activates a self-driving JVM stressor that retain N bytes of heap memory in M-sized chunks inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor retain N bytes of heap memory in M-sized chunks. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosHeapPressures}) to
