...
/**
 * L1 chaos primitive: inject {@code EMFILE} on every libchaos-net-intercepted
 * {@code accept} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> per-process fd limit reached — typical of fd-leaks in connection pools.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosAcceptEmfile(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
