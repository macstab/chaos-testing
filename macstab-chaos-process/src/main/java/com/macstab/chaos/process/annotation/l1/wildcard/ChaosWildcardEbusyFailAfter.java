 ...
 * @ChaosWildcardEbusyFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEbusyFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEbusyFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEbusyFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEbusyFailAfter(id = "replica",  probability = 0.01)
