...
/**
 * Activates a self-driving JVM stressor that N threads compete for a single lock with long hold
 * times inside the target container's JVM for the duration of the test class or test method.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor N threads compete for a single lock
 * with long hold times. The effect persists throughout the test and is not probabilistic — it runs
 ...
 * ({@code @ChaosMonitorContentions}) to apply different stressor intensities to different
 * containers.
 *
