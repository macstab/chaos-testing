...
/**
 * L1 chaos primitive: inject {@code EACCES} on every libchaos-memory-intercepted {@code
 * mmap(MAP_ANONYMOUS)} call inside the container, gated by {@link #probability}.
 *
 ...
 * production rates for {@code EACCES} on {@code mmap(MAP_ANONYMOUS)}; {@code 1.0} produces
