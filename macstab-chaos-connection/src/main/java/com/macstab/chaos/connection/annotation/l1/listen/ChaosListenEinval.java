...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code listen} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosListenEinvals}) to bind different probabilities to
