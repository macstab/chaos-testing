...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code clock gettime} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosClockGettimeEinvals}) to bind different probabilities to
