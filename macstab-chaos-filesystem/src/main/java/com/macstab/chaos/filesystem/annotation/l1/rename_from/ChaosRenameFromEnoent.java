...
/**
 * Injects {@code ENOENT} on every libchaos-intercepted {@code rename from} call inside the target
 ...
 * exists only because {@code ENOENT} is a valid POSIX result of {@code rename from}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code rename from} call that the libchaos
 ...
 * class. Use the repeatable form ({@code @ChaosRenameFromEnoents}) to bind different probabilities
