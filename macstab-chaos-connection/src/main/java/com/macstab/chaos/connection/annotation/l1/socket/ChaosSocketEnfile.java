...
/**
 * Injects {@code ENFILE} on every libchaos-intercepted {@code socket} call inside the target
 ...
 * exists only because {@code ENFILE} is a valid POSIX result of {@code socket}.
 *
