...
/**
 * Injects {@code ENOMEM} on every libchaos-intercepted {@code bind} call inside the target
 ...
 * exists only because {@code ENOMEM} is a valid POSIX result of {@code bind}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosBindEnomems}) to bind different probabilities to
