 ...
 * @ChaosWildcardEnfileFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEnfileFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEnfileFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEnfileFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEnfileFailAfter(id = "replica",  probability = 0.01)
