 ...
 * @ChaosPosixSpawnEnomemFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEnomemFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnEnomemFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnEnomemFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnEnomemFailAfter(id = "replica",  probability = 0.01)
