...
/**
 * L1 chaos primitive: inject {@code EINVAL} on every libchaos-memory-intercepted
 * {@code every interposed VM} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> invalid argument — bad length / alignment / flags; the universal canary errno.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code EINVAL} on {@code every interposed VM}; {@code 1.0} produces
