...
@DisplayName("L1 Filesystem annotation contract")
class L1FilesystemAnnotationContractTest {

    static Stream<Arguments> allL1Annotations() throws Exception {
        List<Class<?>> result = new ArrayList<>();
        String rootPackage = "com.macstab.chaos.filesystem.annotation.l1";
        String resourcePath = rootPackage.replace('.', '/');
        ClassLoader cl = L1FilesystemAnnotationContractTest.class.getClassLoader();
    ...
    void foundExpectedCount() throws Exception {
        ...
        assertThat(count).isGreaterThanOrEqualTo(53);
    }
}
