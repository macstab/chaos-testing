 ...
 * = {@code POSIX_SPAWNP}, errno = {@code ENFILE}, effect = FAIL_AFTER) tuple. FAIL_AFTER is the
 ...
 * ({@code @ChaosPosixSpawnpEnfileFailAfter.Repeatable}) to apply different counters to different
 * containers.
 *
