...
/**
 * Delays every libchaos-memory-intercepted {@code mprotect} call by {@link #delayMs} milliseconds
 ...
 * = {@code MPROTECT}, effect = LATENCY) pair. Unlike the errno variants, the latency primitive
 ...
 * starts. The shared library interposes the libc wrappers for the {@code MPROTECT} syscall family.
 ...
 * ({@code @ChaosMprotectLatencys}) to set different delays on different containers simultaneously.
 *
