...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code posix spawnp} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEinvals}) to bind different probabilities to
