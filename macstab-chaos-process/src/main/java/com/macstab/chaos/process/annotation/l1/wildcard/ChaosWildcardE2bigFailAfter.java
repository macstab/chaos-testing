 ...
 * @ChaosWildcardE2bigFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardE2bigFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardE2bigFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardE2bigFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardE2bigFailAfter(id = "replica",  probability = 0.01)
