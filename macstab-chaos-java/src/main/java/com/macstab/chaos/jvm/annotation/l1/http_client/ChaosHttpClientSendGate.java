...
/**
 * Block the http_client_send operation until released or the configured timeout elapses.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> block the HTTP_CLIENT_SEND operation until released or the configured timeout elapses inside the JVM of the target container.
 ...
 * ({@code @ChaosHttpClientSendGates}) to apply different configurations to different containers.
 *
