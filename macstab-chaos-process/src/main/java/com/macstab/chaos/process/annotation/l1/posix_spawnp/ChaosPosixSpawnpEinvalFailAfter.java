 ...
 * = {@code POSIX_SPAWNP}, errno = {@code EINVAL}, effect = FAIL_AFTER) tuple. FAIL_AFTER is the
 ...
 * ({@code @ChaosPosixSpawnpEinvalFailAfter.Repeatable}) to apply different counters to different
 * containers.
 *
