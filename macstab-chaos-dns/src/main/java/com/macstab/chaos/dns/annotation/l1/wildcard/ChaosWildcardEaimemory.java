...
/**
 * Injects {@code EAI_MEMORY} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code EAI_MEMORY} is a valid POSIX result of {@code wildcard}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEaimemorys}) to bind different probabilities
