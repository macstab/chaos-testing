...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code accept} call inside
 ...
 * {@code accept}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code accept} call that the
 ...
 * class. Use the repeatable form ({@code @ChaosAcceptEinvals}) to bind different probabilities to
