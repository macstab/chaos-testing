 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the JDBC_TRANSACTION_ROLLBACK operation by the
 ...
 * ({@code @ChaosJdbcTransactionRollbackDelays}) to apply different configurations to different
 * containers.
 *
