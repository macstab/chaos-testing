...
/**
 * Injects {@code ENOENT} on every libchaos-intercepted {@code rename from} call inside
 ...
 * {@code rename from}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code rename from} call that the
 ...
 * class. Use the repeatable form ({@code @ChaosRenameFromEnoents}) to bind different probabilities to
