 ...
 *
 * <p><strong>What chaos this applies:</strong> complete the CompletableFuture exceptionally before normal completion fires inside the JVM of the target container.
 ...
 * ({@code @ChaosAsyncCompleteExceptionalCompletions}) to apply different configurations to different containers.
 *
