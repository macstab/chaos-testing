...
/**
 * Injects {@code E2BIG} on every libchaos-intercepted {@code execveat} call inside the target
 ...
 * exists only because {@code E2BIG} is a valid POSIX result of {@code execveat}.
 *
