...
/**
 * Delays every libchaos-intercepted {@code pread} call by {@link #delayMs}
 ...
 *
 * <p><strong>What chaos this applies:</strong> every {@code pread} call intercepted
 ...
 * applies to every capable container. Use the repeatable form ({@code @ChaosPreadLatencys}) to set
