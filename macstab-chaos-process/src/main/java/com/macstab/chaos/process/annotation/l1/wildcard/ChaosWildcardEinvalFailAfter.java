 ...
 * @ChaosWildcardEinvalFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEinvalFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEinvalFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEinvalFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEinvalFailAfter(id = "replica",  probability = 0.01)
