 ...
 * @ChaosWildcardEnomemFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEnomemFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEnomemFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEnomemFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEnomemFailAfter(id = "replica",  probability = 0.01)
