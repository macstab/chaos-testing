...
/**
 * Activates a self-driving JVM stressor that pin virtual-thread carriers via synchronized blocks inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor pin virtual-thread carriers via synchronized blocks. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosVirtualThreadCarrierPinnings}) to
