 ...
 * 5–15% of requests fail during pod shutdown; the failure window affects every rolling deploy and
 * every HPA scale-down event.
 *
...
@ChaosL3(
    composer = "com.macstab.chaos.kubernetes.testpack.l3.composers.K8sSidecarShutdownRaceComposer",
