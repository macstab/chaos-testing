 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at {@code
 * METHOD_ENTER} for matched methods inside the JVM of the target container. The effect fires on
 ...
 * ({@code @ChaosMethodEnterInjectExceptions}) to apply different configurations to different
 * containers.
 *
