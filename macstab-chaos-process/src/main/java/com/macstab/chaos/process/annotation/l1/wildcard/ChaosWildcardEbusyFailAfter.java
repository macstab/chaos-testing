 ...
 * (selector = {@code WILDCARD}, errno = {@code EBUSY}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = EBUSY}, regardless of real
 ...
 * @ChaosWildcardEbusyFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosWildcardEbusyFailAfter.Repeatable}) to apply different counters to different containers.
 *
