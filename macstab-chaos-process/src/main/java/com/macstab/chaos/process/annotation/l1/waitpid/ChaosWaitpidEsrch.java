...
/**
 * Injects {@code ESRCH} on every libchaos-intercepted {@code waitpid} call inside the target
 ...
 * exists only because {@code ESRCH} is a valid POSIX result of {@code waitpid}.
 *
