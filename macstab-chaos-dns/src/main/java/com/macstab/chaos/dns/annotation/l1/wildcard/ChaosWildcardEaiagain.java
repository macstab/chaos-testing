...
/**
 * Injects {@code EAI_AGAIN} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code EAI_AGAIN} is a valid POSIX result of {@code wildcard}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEaiagains}) to bind different probabilities
