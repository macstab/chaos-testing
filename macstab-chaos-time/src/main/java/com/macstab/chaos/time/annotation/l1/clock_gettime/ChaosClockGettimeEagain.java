...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code clock gettime} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosClockGettimeEagains}) to bind different probabilities to
