...
/**
 * L1 chaos primitive: reject the SHUTDOWN_HOOK_REGISTER operation by throwing an appropriate exception for the operation type.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.SHUTDOWN, operationType = OperationType.SHUTDOWN_HOOK_REGISTER)
