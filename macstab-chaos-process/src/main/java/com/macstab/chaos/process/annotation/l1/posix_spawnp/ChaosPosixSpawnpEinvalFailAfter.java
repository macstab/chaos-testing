 ...
 * (selector = {@code POSIX_SPAWNP}, errno = {@code EINVAL}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosPosixSpawnpEinvalFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosPosixSpawnpEinvalFailAfter.Repeatable}) to apply different counters to different containers.
 *
