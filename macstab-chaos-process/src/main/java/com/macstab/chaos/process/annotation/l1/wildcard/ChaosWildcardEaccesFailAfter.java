 ...
 * @ChaosWildcardEaccesFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEaccesFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEaccesFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEaccesFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEaccesFailAfter(id = "replica",  probability = 0.01)
