...
/**
 * L1 chaos primitive: inject {@code ENOBUFS} on every libchaos-net-intercepted {@code send}
 ...
 * }</pre>
 *
 * <p><strong>Scope:</strong> applies to every {@code send} call across all endpoints. For
