 ...
 */
public final class K8sCpuThrottleGcAmplificationComposer
    implements L3Composer<IncidentChaosK8sCpuThrottleGcAmplification> {

  public K8sCpuThrottleGcAmplificationComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosK8sCpuThrottleGcAmplification ann) {
    ...
    handles.add(
        adv.apply(
            container,
            NetRule.latency(
                Endpoint.wildcard(), NetOperation.RECV, Duration.ofSeconds(30), ann.toxicity())));
