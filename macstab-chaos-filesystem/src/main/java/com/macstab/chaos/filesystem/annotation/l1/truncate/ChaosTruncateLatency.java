...
/**
 * Delays every libchaos-intercepted {@code truncate} call by {@link #delayMs}
 ...
 *
 * <p><strong>What chaos this applies:</strong> every {@code truncate} call intercepted
 ...
 * applies to every capable container. Use the repeatable form ({@code @ChaosTruncateLatencys}) to set
