 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the SOCKET_READ operation by the configured number of milliseconds inside the JVM of the target container.
