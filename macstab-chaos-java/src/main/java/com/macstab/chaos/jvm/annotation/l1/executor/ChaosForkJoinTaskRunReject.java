...
/**
 * L1 chaos primitive: reject the FORK_JOIN_TASK_RUN operation by throwing an appropriate exception for the operation type.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.EXECUTOR, operationType = OperationType.FORK_JOIN_TASK_RUN)
