 ...
 * JDBC_CONNECTION_ACQUIRE call site inside the JVM of the target container. The effect fires on
 ...
 * ({@code @ChaosJdbcConnectionAcquireInjectExceptions}) to apply different configurations to
