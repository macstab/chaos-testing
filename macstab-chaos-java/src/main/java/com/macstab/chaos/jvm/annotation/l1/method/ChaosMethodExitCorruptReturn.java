 ...
 *
 * <p><strong>What chaos this applies:</strong> replace the return value at {@code METHOD_EXIT} for
 * matched methods inside the JVM of the target container. The effect fires on every matching call,
 ...
 * ({@code @ChaosMethodExitCorruptReturns}) to apply different configurations to different
 * containers.
 *
