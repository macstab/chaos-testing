 ...
 * (selector = {@code WILDCARD}, errno = {@code EMFILE}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = EMFILE}, regardless of real
 ...
 * ({@code @ChaosWildcardEmfileFailAfter.Repeatable}) to apply different counters to different containers.
 *
