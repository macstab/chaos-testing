...
/**
 * L1 chaos primitive: inject {@code EINTR} on every libchaos-net-intercepted
 * {@code recv} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> interrupted system call — signal during recv; canary for signal-handling correctness.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
