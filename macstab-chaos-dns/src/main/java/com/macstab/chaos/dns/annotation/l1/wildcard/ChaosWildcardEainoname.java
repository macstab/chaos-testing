...
/**
 * Injects {@code EAI_NONAME} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code EAI_NONAME} is a valid POSIX result of {@code wildcard}.
 *
 ...
 * @ChaosWildcardEainoname(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEainonames}) to bind different probabilities
