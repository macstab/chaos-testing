...
/**
 * Injects {@code EAI_AGAIN} on every libchaos-intercepted {@code reverse} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosReverseEaiagains}) to bind different probabilities to
