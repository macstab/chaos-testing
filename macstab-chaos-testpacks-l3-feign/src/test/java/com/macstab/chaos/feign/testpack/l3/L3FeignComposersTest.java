...
class L3FeignComposersTest {
    ...
    void feignHystrixThreadLeakHasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosFeignHystrixThreadLeak.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void feignHystrixThreadLeakIsRepeatable() {
        assertThat(IncidentChaosFeignHystrixThreadLeak.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void feignRetryAmplificationHasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosFeignRetryAmplification.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void feignRetryAmplificationIsRepeatable() {
        assertThat(IncidentChaosFeignRetryAmplification.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void feignStaleLoadBalancerHasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosFeignStaleLoadBalancer.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void feignStaleLoadBalancerIsRepeatable() {
        assertThat(IncidentChaosFeignStaleLoadBalancer.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void feignChunkedConnectionLeakHasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosFeignChunkedConnectionLeak.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void feignChunkedConnectionLeakIsRepeatable() {
        assertThat(IncidentChaosFeignChunkedConnectionLeak.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void okHttpMetastablePoolIsRepeatable() {
        assertThat(IncidentChaosOkHttpMetastablePool.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void allComposerClassNamesReferenceCorrectPackage() {
        ...
        assertThat(IncidentChaosFeignStaleLoadBalancer.class.getAnnotation(ChaosL3.class).composer())
                .startsWith(expectedPackage);
        assertThat(IncidentChaosFeignChunkedConnectionLeak.class.getAnnotation(ChaosL3.class).composer())
                .startsWith(expectedPackage);
