 ...
 * chaos unit. It encodes exactly one (selector = {@code MMAP_FILE}, errno = {@code EPERM}) pair.
 ...
 * the test class. Use the repeatable form ({@code @ChaosMmapFileEperms}) to bind different
