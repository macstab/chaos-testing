 ...
 * time, and JVM — to simulate named, compound production incidents that real gRPC deployments have
 * experienced: deadline propagation failures, connection drain during rolling deploys, and
 * load-balancing name-resolution failures.
 *
