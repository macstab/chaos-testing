...
/**
 * Verifies that every cache L3 incident annotation carries the {@link ChaosL3} meta-annotation
...
class L3CacheComposersTest {
    ...
    void cacheStampede_isRepeatable() {
        assertThat(IncidentChaosCacheStampede.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void cacheWarmingFailure_isRepeatable() {
        assertThat(IncidentChaosCacheWarmingFailure.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void cacheSerializationMismatch_hasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosCacheSerializationMismatch.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void cacheSerializationMismatch_isRepeatable() {
        assertThat(IncidentChaosCacheSerializationMismatch.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void caffeineEvictionDeadlock_hasChaosL3MetaAnnotation() {
        assertThat(IncidentChaosCaffeineEvictionDeadlock.class.isAnnotationPresent(ChaosL3.class)).isTrue();
    }
    ...
    void caffeineEvictionDeadlock_isRepeatable() {
        assertThat(IncidentChaosCaffeineEvictionDeadlock.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void hazelcastSplitBrain_isRepeatable() {
        assertThat(IncidentChaosHazelcastSplitBrain.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void allComposerClassNamesReferenceCorrectPackage() {
        ...
        assertThat(IncidentChaosCacheWarmingFailure.class.getAnnotation(ChaosL3.class).composer())
                .startsWith(expectedPackage);
        assertThat(IncidentChaosCacheSerializationMismatch.class.getAnnotation(ChaosL3.class).composer())
                .startsWith(expectedPackage);
