...
/**
 * L1 chaos primitive: delay the REFLECTION_INVOKE operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#REFLECTION_INVOKE
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.REFLECTION_INVOKE)
