 ...
 * = {@code POSIX_SPAWN}, errno = {@code EMFILE}, effect = FAIL_AFTER) tuple. FAIL_AFTER is the
 ...
 * ({@code @ChaosPosixSpawnEmfileFailAfter.Repeatable}) to apply different counters to different
 * containers.
 *
