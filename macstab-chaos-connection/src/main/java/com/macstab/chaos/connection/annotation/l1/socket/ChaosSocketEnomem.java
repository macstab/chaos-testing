...
/**
 * Injects {@code ENOMEM} on every libchaos-intercepted {@code socket} call inside the target
 ...
 * exists only because {@code ENOMEM} is a valid POSIX result of {@code socket}.
 *
 ...
 * @ChaosSocketEnomem(toxicity = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosSocketEnomems}) to bind different probabilities to
