 ...
 *
 * <p>Injects a RECV timeout that hangs the chunked response indefinitely, preventing the connection
 * from ever being returned to the Apache HttpClient pool — reproducing the silent pool-drain
 * described in OpenFeign issue #1474.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class FeignChunkedConnectionLeakComposer
    implements L3Composer<IncidentChaosFeignChunkedConnectionLeak> {

  public FeignChunkedConnectionLeakComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosFeignChunkedConnectionLeak ann) {
