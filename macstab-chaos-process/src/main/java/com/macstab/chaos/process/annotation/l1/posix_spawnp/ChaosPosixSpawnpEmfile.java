...
/**
 * Injects {@code EMFILE} on every libchaos-intercepted {@code posix spawnp} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEmfiles}) to bind different probabilities to
