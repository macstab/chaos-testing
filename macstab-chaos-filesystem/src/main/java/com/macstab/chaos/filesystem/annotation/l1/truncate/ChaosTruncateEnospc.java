...
/**
 * Injects {@code ENOSPC} on every libchaos-intercepted {@code truncate} call inside
 ...
 * {@code truncate}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code truncate} call that the
