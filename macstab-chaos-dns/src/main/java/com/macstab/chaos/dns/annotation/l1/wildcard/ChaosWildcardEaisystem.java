...
/**
 * Injects {@code EAI_SYSTEM} on every libchaos-intercepted {@code wildcard} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEaisystems}) to bind different probabilities to
