...
/**
 * Injects {@code EMFILE} on every libchaos-intercepted {@code socket} call inside the target
 ...
 * exists only because {@code EMFILE} is a valid POSIX result of {@code socket}.
 *
