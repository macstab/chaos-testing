...
/**
 * L1 chaos primitive: delay the ZIP_DEFLATE operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#ZIP_DEFLATE
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.ZIP_DEFLATE)
