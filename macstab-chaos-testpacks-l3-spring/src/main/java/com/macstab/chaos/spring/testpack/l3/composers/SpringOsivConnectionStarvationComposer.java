 ...
 *
 * <p>Applies RECV latency on all connections to reproduce the connection pool exhaustion caused by
 * Spring's Open Session In View default — each connection is held open during HTTP response
 * serialization, draining the pool at traffic spikes.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class SpringOsivConnectionStarvationComposer
    implements L3Composer<IncidentChaosSpringOsivConnectionStarvation> {

  public SpringOsivConnectionStarvationComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosSpringOsivConnectionStarvation ann) {
