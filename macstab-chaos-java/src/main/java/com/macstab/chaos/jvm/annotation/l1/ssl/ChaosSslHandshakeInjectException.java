 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the SSL_HANDSHAKE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosSslHandshakeInjectExceptions}) to apply different configurations to different containers.
 *
