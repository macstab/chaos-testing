 ...
 * @ChaosWildcardEchildFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEchildFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEchildFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEchildFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEchildFailAfter(id = "replica",  probability = 0.01)
