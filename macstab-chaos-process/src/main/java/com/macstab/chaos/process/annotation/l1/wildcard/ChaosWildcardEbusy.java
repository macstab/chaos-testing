...
/**
 * Injects {@code EBUSY} on every libchaos-intercepted {@code wildcard} call inside the target
 ...
 * exists only because {@code EBUSY} is a valid POSIX result of {@code wildcard}.
 *
 ...
 * the interceptor returns {@code -1} and sets {@code errno = EBUSY} — from the application's
 * perspective this is indistinguishable from a real kernel-level failure. Specifically this
 * simulates: device or resource busy — typical of pthread_attr exhaustion.
 *
