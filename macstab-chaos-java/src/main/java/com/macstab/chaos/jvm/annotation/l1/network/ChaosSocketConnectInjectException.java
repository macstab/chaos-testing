 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the SOCKET_CONNECT
 ...
 * ({@code @ChaosSocketConnectInjectExceptions}) to apply different configurations to different
 * containers.
 *
