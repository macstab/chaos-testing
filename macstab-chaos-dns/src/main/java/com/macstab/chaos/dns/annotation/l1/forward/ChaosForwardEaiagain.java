...
/**
 * Injects {@code EAI_AGAIN} on every libchaos-intercepted {@code forward} call inside the target
 ...
 * exists only because {@code EAI_AGAIN} is a valid POSIX result of {@code forward}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosForwardEaiagains}) to bind different probabilities
