...
/**
 * Verifies that every Kafka L3 incident annotation carries the {@link ChaosL3} meta-annotation
 * with a non-blank composer class name.
 *
...
class L3KafkaComposersTest {
    ...
    void kafkaZookeeperLoss_isRepeatable() {
        assertThat(IncidentChaosKafkaZookeeperLoss.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void kafkaUncleanLeaderElection_isRepeatable() {
        assertThat(IncidentChaosKafkaUncleanLeaderElection.class.isAnnotationPresent(java.lang.annotation.Repeatable.class)).isTrue();
    }
    ...
    void allAnnotations_composerClassNameMatchesExpectedPackage() {
        ...
        assertThat(IncidentChaosKafkaZookeeperLoss.class.getAnnotation(ChaosL3.class).composer())
                .startsWith("com.macstab.chaos.kafka.testpack.l3.composers.");
        assertThat(IncidentChaosKafkaUncleanLeaderElection.class.getAnnotation(ChaosL3.class).composer())
                .startsWith("com.macstab.chaos.kafka.testpack.l3.composers.");
    }
}
