 ...
 * (selector = {@code WILDCARD}, errno = {@code E2BIG}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = E2BIG}, regardless of real
 ...
 * @ChaosWildcardE2bigFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosWildcardE2bigFailAfter.Repeatable}) to apply different counters to different containers.
 *
