...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code pthread create} call inside the
 ...
 * exists only because {@code EAGAIN} is a valid POSIX result of {@code pthread create}.
 *
 ...
 * @ChaosPthreadCreateEagain(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPthreadCreateEagains}) to bind different
