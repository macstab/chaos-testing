...
/**
 * L1 chaos primitive: inject {@code ENOTCONN} on every libchaos-net-intercepted
 * {@code shutdown} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> socket not connected — typical of shutdown on idle socket race.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
