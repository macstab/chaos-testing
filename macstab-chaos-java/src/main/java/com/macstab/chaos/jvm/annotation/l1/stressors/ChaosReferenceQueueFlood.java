...
/**
 * Activates a self-driving JVM stressor that flood the ReferenceHandler thread's queue with WeakReferences inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor flood the ReferenceHandler thread's queue with WeakReferences. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosReferenceQueueFloods}) to
