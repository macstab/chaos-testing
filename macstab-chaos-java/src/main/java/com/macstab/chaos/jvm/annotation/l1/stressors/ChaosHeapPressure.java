...
/**
 * Activates a self-driving JVM stressor that retain N bytes of heap memory in M-sized chunks inside
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor retain N bytes of heap memory in
 * M-sized chunks. The effect persists throughout the test and is not probabilistic — it runs
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosHeapPressures})
 * to apply different stressor intensities to different containers.
 *
