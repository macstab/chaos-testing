 ...
 * @ChaosPosixSpawnpEinvalFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEinvalFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnpEinvalFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnpEinvalFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnpEinvalFailAfter(id = "replica",  probability = 0.01)
