...
/**
 * Injects {@code ENFILE} on every libchaos-intercepted {@code posix spawnp} call inside
 ...
 * {@code posix spawnp}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code posix spawnp} call that the
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnfiles}) to bind different probabilities to
