...
/**
 * Injects {@code EAI_MEMORY} on every libchaos-intercepted {@code reverse} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosReverseEaimemorys}) to bind different probabilities to
