...
/**
 * Delay the socket_close operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the SOCKET_CLOSE operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosSocketCloseDelays}) to apply different configurations to different containers.
 *
