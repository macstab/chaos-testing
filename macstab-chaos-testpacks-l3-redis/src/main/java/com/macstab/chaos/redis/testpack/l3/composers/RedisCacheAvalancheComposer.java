 ...
 *
 * <p>Slows new Redis connections and forces cache lookup methods to return null to reproduce the
 * mass cache-miss thundering-herd against the backing store.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class RedisCacheAvalancheComposer
    implements L3Composer<IncidentChaosRedisCacheAvalanche> {

  public RedisCacheAvalancheComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosRedisCacheAvalanche ann) {
