...
class L3SpringComposersTest {
  ...
  void transactionalPoolDeadlock_hasChaosL3MetaAnnotation() {
    assertThat(
            IncidentChaosSpringTransactionalPoolDeadlock.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void transactionalPoolDeadlock_severityIsCritical() {
    final var meta =
        IncidentChaosSpringTransactionalPoolDeadlock.class.getAnnotation(ChaosL3.class);
  ...
  void transactionalPoolDeadlock_isRepeatable() {
    assertThat(
            IncidentChaosSpringTransactionalPoolDeadlock.class.isAnnotationPresent(
  ...
  void webFluxReactorStarvation_hasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosSpringWebFluxReactorStarvation.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void webFluxReactorStarvation_isRepeatable() {
    assertThat(
            IncidentChaosSpringWebFluxReactorStarvation.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void osivConnectionStarvation_hasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosSpringOsivConnectionStarvation.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void osivConnectionStarvation_isRepeatable() {
    assertThat(
            IncidentChaosSpringOsivConnectionStarvation.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void configRefreshWave_hasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosSpringConfigRefreshWave.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void configRefreshWave_isRepeatable() {
    assertThat(
            IncidentChaosSpringConfigRefreshWave.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void allAnnotationsHaveIdAttribute() throws Exception {
    assertThat(IncidentChaosSpringTransactionalPoolDeadlock.class.getDeclaredMethod("id"))
        .isNotNull();
    assertThat(IncidentChaosSpringWebFluxReactorStarvation.class.getDeclaredMethod("id"))
        .isNotNull();
    assertThat(IncidentChaosSpringOsivConnectionStarvation.class.getDeclaredMethod("id"))
        .isNotNull();
  ...
  void allComposerClassNamesReferenceCorrectPackage() {
    ...
    assertThat(
            IncidentChaosSpringTransactionalPoolDeadlock.class
                .getAnnotation(ChaosL3.class)
                .composer())
        .startsWith(expectedPackage);
    assertThat(
            IncidentChaosSpringWebFluxReactorStarvation.class
                .getAnnotation(ChaosL3.class)
                .composer())
        .startsWith(expectedPackage);
    assertThat(
            IncidentChaosSpringOsivConnectionStarvation.class
                .getAnnotation(ChaosL3.class)
                .composer())
        .startsWith(expectedPackage);
