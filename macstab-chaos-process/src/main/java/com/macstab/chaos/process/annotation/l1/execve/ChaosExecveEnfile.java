...
/**
 * Injects {@code ENFILE} on every libchaos-intercepted {@code execve} call inside the target
 ...
 * exists only because {@code ENFILE} is a valid POSIX result of {@code execve}.
 *
