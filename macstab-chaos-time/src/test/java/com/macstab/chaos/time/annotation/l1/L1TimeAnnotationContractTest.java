...
@DisplayName("L1 Time annotation contract")
class L1TimeAnnotationContractTest {

    static Stream<Arguments> allL1Annotations() throws Exception {
        List<Class<?>> result = new ArrayList<>();
        String rootPackage = "com.macstab.chaos.time.annotation.l1";
        String resourcePath = rootPackage.replace('.', '/');
        ClassLoader cl = L1TimeAnnotationContractTest.class.getClassLoader();
