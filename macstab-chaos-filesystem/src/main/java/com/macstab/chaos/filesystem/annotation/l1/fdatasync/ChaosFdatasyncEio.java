...
/**
 * Injects {@code EIO} on every libchaos-intercepted {@code fdatasync} call inside the target
 ...
 * exists only because {@code EIO} is a valid POSIX result of {@code fdatasync}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosFdatasyncEios}) to bind different probabilities to
