...
/**
 * L1 chaos primitive: inject {@code EBUSY} on every libchaos-process-intercepted
 * {@code pthread_create} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> device or resource busy — typical of pthread_attr exhaustion or stack-pool contention.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code EBUSY} on {@code pthread_create}; {@code 1.0} typically
