 ...
 * @ChaosWaitpidEsrchFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWaitpidEsrchFailAfters}) to bind different probabilities to
...
public @interface ChaosWaitpidEsrchFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWaitpidEsrchFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWaitpidEsrchFailAfter(id = "replica",  probability = 0.01)
