 ...
 * Sustained throughput drop causes consumer lag to accumulate; once lag exceeds the rebalance
 * threshold or {@code max.poll.interval.ms} is breached, the consumer group rebalances, amplifying
 * the initial degradation.
 *
 * <h2>Industry references</h2>
 *
 * <p>Sustained network throughput drop with consumer lag accumulation eventually triggering
 * rebalance is a common pattern in cloud-hosted Kafka deployments during network congestion events.
 * Documented in Confluent operator guides as a trigger for cascading lag buildup.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@ChaosL3(
    composer = "com.macstab.chaos.kafka.testpack.l3.composers.KafkaNetworkDegradationComposer",
