...
/**
 * L1 chaos primitive: silently suppress the SCHEDULE_SUBMIT operation; callers receive null/false/no-op per operation semantics.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.SCHEDULING, operationType = OperationType.SCHEDULE_SUBMIT)
