...
/**
 * Injects {@code EMFILE} on every libchaos-intercepted {@code execve} call inside the target
 ...
 * exists only because {@code EMFILE} is a valid POSIX result of {@code execve}.
 *
