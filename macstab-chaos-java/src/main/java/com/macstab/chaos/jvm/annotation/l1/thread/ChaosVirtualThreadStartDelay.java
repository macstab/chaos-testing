...
/**
 * L1 chaos primitive: delay the VIRTUAL_THREAD_START operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.THREAD, operationType = OperationType.VIRTUAL_THREAD_START)
