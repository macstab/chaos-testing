...
/**
 * Injects {@code EINTR} on every libchaos-intercepted {@code clock gettime} call inside the target
 ...
 * exists only because {@code EINTR} is a valid POSIX result of {@code clock gettime}.
 *
 ...
 * it fires the interceptor returns {@code -1} and sets {@code errno = EINTR} — from the
 ...
 * class. Use the repeatable form ({@code @ChaosClockGettimeEintrs}) to bind different probabilities
