 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the NIO_CHANNEL_WRITE operation by the configured number of milliseconds inside the JVM of the target container.
