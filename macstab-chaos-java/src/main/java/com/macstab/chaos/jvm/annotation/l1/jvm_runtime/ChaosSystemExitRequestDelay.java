...
/**
 * Delay the system_exit_request operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the SYSTEM_EXIT_REQUEST operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosSystemExitRequestDelays}) to apply different configurations to different containers.
 *
