 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Severe</strong><br>Heap metrics are completely clean throughout; the
 * failure is invisible until the final {@code OutOfMemoryError: Metaspace}. In production this
 * manifests as a pod that crashes unpredictably after days of operation.
 *
...
@ChaosL3(composer = "com.macstab.chaos.jvm.testpack.l3.composers.JvmMetaspaceGlacierComposer", severity = Severity.SEVERE)
