 ...
 * <h2>Composed of</h2>
 * <ul>
 *   <li>JVM: SafepointStorm every {@code gcIntervalMs} ms — forces stop-the-world pauses that
 *       make all downstream timeouts fire simultaneously on resume
 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>A single GC pause causes simultaneous failure across
 * all dependent systems; retry storms from multiple clients amplify the disruption.
 *
...
@ChaosL3(composer = "com.macstab.chaos.jvm.testpack.l3.composers.JvmSafepointCascadeComposer", severity = Severity.CRITICAL)
