 ...
 * (selector = {@code POSIX_SPAWNP}, errno = {@code ENFILE}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosPosixSpawnpEnfileFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosPosixSpawnpEnfileFailAfter.Repeatable}) to apply different counters to different containers.
 *
