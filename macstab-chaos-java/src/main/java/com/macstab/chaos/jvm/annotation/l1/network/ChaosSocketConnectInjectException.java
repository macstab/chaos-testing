...
/**
 * Throw the configured exception at the socket_connect call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the SOCKET_CONNECT call site inside the JVM of the target container.
 ...
 * ({@code @ChaosSocketConnectInjectExceptions}) to apply different configurations to different containers.
 *
