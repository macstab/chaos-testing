...
/**
 * Delay the http_client_send operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the HTTP_CLIENT_SEND operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosHttpClientSendDelays}) to apply different configurations to different containers.
 *
