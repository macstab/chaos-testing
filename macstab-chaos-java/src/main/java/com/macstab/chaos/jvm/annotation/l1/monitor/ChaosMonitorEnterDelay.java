...
/**
 * L1 chaos primitive: delay the MONITOR_ENTER operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.MONITOR, operationType = OperationType.MONITOR_ENTER)
