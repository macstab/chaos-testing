...
/**
 * L1 chaos primitive: inject {@code ENODEV} on every libchaos-memory-intercepted
 * {@code mmap(MAP_ANONYMOUS)} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> no such device — typical of memory-backed device removal / hot-unplug.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code ENODEV} on {@code mmap(MAP_ANONYMOUS)}; {@code 1.0} produces
