 ...
 * @ChaosPosixSpawnpEnoentFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnoentFailAfters}) to bind different probabilities to
...
public @interface ChaosPosixSpawnpEnoentFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPosixSpawnpEnoentFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPosixSpawnpEnoentFailAfter(id = "replica",  probability = 0.01)
