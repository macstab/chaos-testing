 ...
 * (selector = {@code POSIX_SPAWNP}, errno = {@code ENOENT}, effect = FAIL_AFTER) tuple.
 ...
 * ({@code @ChaosPosixSpawnpEnoentFailAfter.Repeatable}) to apply different counters to different containers.
 *
