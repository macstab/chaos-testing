...
/**
 * Throw the configured exception at the jmx_invoke call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JMX_INVOKE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosJmxInvokeInjectExceptions}) to apply different configurations to different containers.
 *
