...
/**
 * Injects {@code EAGAIN} on every libchaos-intercepted {@code pthread create} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPthreadCreateEagains}) to bind different probabilities to
