...
/**
 * Injects {@code ENOMEM} on every libchaos-intercepted {@code posix spawnp} call inside the target
 ...
 * exists only because {@code ENOMEM} is a valid POSIX result of {@code posix spawnp}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnpEnomems}) to bind different probabilities
