 ...
 * (selector = {@code WILDCARD}, errno = {@code EINVAL}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = EINVAL}, regardless of real
 ...
 * ({@code @ChaosWildcardEinvalFailAfter.Repeatable}) to apply different counters to different containers.
 *
