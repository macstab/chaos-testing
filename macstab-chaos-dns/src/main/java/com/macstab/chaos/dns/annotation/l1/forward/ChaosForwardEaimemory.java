...
/**
 * Injects {@code EAI_MEMORY} on every libchaos-intercepted {@code forward} call inside
 ...
 * @ChaosForwardEaimemory(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosForwardEaimemorys}) to bind different probabilities to
