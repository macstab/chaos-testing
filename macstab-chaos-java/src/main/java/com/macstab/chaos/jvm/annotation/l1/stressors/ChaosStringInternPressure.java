...
/**
 * Activates a self-driving JVM stressor that intern many strings to exhaust the JVM string table inside the target container's JVM for the
 ...
 *
 * <p><strong>What chaos this applies:</strong> the stressor intern many strings to exhaust the JVM string table. The effect persists
 ...
 * applies to every agent-capable container. Use the repeatable form ({@code @ChaosStringInternPressures}) to
