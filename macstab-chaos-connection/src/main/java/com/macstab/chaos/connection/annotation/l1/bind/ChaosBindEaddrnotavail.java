...
/**
 * L1 chaos primitive: inject {@code EADDRNOTAVAIL} on every libchaos-net-intercepted
 * {@code bind} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> address not available — interface unconfigured; typical of network-setup races.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosBindEaddrnotavail(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
 * <p><strong>Scope:</strong> applies to every {@code bind} call across all endpoints.
