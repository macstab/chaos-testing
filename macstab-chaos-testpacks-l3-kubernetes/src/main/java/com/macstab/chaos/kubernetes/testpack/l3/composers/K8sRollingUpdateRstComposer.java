 ...
 *
 * <p>Injects RECV ECONNRESET at the configured toxicity to reproduce the TCP RST window caused by
 * iptables endpoint propagation lag during Kubernetes rolling updates.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class K8sRollingUpdateRstComposer
    implements L3Composer<IncidentChaosK8sRollingUpdateRst> {

  public K8sRollingUpdateRstComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosK8sRollingUpdateRst ann) {
