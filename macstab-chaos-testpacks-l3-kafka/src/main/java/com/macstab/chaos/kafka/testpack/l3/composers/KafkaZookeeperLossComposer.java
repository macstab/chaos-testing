 ...
 *
 * <p>Applies DNS EAI_FAIL on all forward lookups and connection ECONNREFUSED to reproduce
 * the compound failure profile of ZooKeeper metadata service loss with Kafka producers
 * blocking indefinitely on missing metadata.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class KafkaZookeeperLossComposer implements L3Composer<IncidentChaosKafkaZookeeperLoss> {

    public KafkaZookeeperLossComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosKafkaZookeeperLoss ann) {
