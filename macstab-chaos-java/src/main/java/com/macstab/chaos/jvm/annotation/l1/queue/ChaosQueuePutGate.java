 ...
 *
 * <p><strong>What chaos this applies:</strong> block the QUEUE_PUT operation until released or the configured timeout elapses inside the JVM of the target container.
