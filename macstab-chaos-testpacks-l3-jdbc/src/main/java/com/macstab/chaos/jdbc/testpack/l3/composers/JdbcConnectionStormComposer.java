...
@Slf4j
public final class JdbcConnectionStormComposer
    implements L3Composer<IncidentChaosJdbcConnectionStorm> {
  ...
  public List<Object> apply(
    ...
    final ChaosScenario scenario =
        ChaosScenario.builder(scenarioId)
            ...
            .effect(
                ChaosEffect.injectException("java.sql.SQLException", "connection pool exhausted"))
    ...
    for (final Object h : handles) {
      if (h instanceof RuleHandle rh) {
        ...
        try {
          ...
          log.warn(
              "JdbcConnectionStormComposer.removeAll: failed to remove JVM scenario {}",
              scenarioId,
              e);
        }
      }
