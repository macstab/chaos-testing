...
/**
 * L1 chaos primitive: inject {@code EPERM} on every libchaos-memory-intercepted
 * {@code mmap(MAP_ANONYMOUS)} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> operation not permitted — typical of capability-dropped containers performing privileged VM ops.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code EPERM} on {@code mmap(MAP_ANONYMOUS)}; {@code 1.0} produces
