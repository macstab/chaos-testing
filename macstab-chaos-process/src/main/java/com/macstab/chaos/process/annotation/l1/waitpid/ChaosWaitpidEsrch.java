...
/**
 * L1 chaos primitive: inject {@code ESRCH} on every libchaos-process-intercepted
 * {@code waitpid} call inside the container, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> no such process — typical of waitpid race after the child has been reaped.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * production rates for {@code ESRCH} on {@code waitpid}; {@code 1.0} typically
