...
/**
 * L1 chaos primitive: reject the SOCKET_CONNECT operation by throwing an appropriate exception for the operation type.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#SOCKET_CONNECT
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.NETWORK, operationType = OperationType.SOCKET_CONNECT)
