...
/**
 * Injects {@code EINTR} on every libchaos-intercepted {@code wildcard} call inside
 ...
 * @ChaosWildcardEintr(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEintrs}) to bind different probabilities to
