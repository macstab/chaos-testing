...
/**
 * L1 chaos primitive: inject {@code EINVAL} on every libchaos-net-intercepted
 * {@code accept} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> invalid argument — bad sockaddr / option / size; the universal canary errno.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosAcceptEinval(toxicity = 0.1)
 * class MyTest { ... }
 * }</pre>
 *
