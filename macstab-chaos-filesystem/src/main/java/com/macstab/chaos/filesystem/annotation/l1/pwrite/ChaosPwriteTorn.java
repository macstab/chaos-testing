...
/**
 * Injects {@code ERRNO} on every libchaos-intercepted {@code pwrite} call inside the target
 ...
 * exists only because {@code ERRNO} is a valid POSIX result of {@code pwrite}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosPwriteTorns}) to bind different probabilities to
