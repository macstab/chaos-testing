...
/**
 * Delay the zip_deflate operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the ZIP_DEFLATE operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosZipDeflateDelays}) to apply different configurations to different containers.
 *
