 ...
 * reproduce the compound failure profile of a GC-pause-induced timeout cascade across all connected
 * systems.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class JvmSafepointCascadeComposer
    implements L3Composer<IncidentChaosJvmSafepointCascade> {

  public JvmSafepointCascadeComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosJvmSafepointCascade ann) {
  ...
  public List<String> describe(final IncidentChaosJvmSafepointCascade ann) {
    return List.of(
        ...
        "connection: RECV ECONNRESET toxicity="
            + ann.toxicity()
            + " (HikariCP/Kafka/ZK timeouts cascade)",
