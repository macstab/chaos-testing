...
/**
 * L1 chaos primitive: inject {@code EACCES} on every libchaos-process-intercepted {@code execve}
 ...
 * production rates for {@code EACCES} on {@code execve}; {@code 1.0} typically breaks container
