 ...
 * (selector = {@code PTHREAD_CREATE}, errno = {@code EAGAIN}, effect = FAIL_AFTER) tuple.
 ...
 * ({@code @ChaosPthreadCreateEagainFailAfter.Repeatable}) to apply different counters to different containers.
 *
