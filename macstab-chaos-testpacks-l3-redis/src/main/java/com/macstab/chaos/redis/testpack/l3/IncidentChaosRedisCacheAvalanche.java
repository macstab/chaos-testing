 ...
 *   <li>JVM: {@code replaceReturn()} on methods matching {@code classPattern} — forces cache lookup
 *       methods to return null, simulating 100% cache miss rate at the Java layer
 * </ul>
 *
 * <h2>How bad it is</h2>
 *
 * <p>Severity: <strong>Critical</strong><br>
 * The backing store absorbs the full request load with no cache shielding; connection-pool
 * exhaustion and cascading timeouts follow within seconds.
 *
...
@ChaosL3(
    composer = "com.macstab.chaos.redis.testpack.l3.composers.RedisCacheAvalancheComposer",
