 ...
 * (selector = {@code WILDCARD}, errno = {@code ENFILE}, effect = FAIL_AFTER) tuple.
 ...
 * every subsequent call returns {@code -1} with {@code errno = ENFILE}, regardless of real
 ...
 * @ChaosWildcardEnfileFailAfter(successesBeforeFailure = 128)
 ...
 * ({@code @ChaosWildcardEnfileFailAfter.Repeatable}) to apply different counters to different containers.
 *
