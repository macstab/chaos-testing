 ...
 * @ChaosPthreadCreateEpermFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosPthreadCreateEpermFailAfters}) to bind different probabilities to
...
public @interface ChaosPthreadCreateEpermFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosPthreadCreateEpermFailAfter(id = "primary",  probability = 0.001)
   * @ChaosPthreadCreateEpermFailAfter(id = "replica",  probability = 0.01)
