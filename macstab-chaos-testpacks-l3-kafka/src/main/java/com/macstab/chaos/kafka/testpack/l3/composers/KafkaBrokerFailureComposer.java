 ...
 *
 * <p>Applies connection ECONNREFUSED, transient DNS EAI_AGAIN, and a JVM TimeoutException
 * to reproduce the compound failure profile of a Kafka broker going down mid-operation with
 * producers and consumers in an active retry storm.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class KafkaBrokerFailureComposer implements L3Composer<IncidentChaosKafkaBrokerFailure> {

    public KafkaBrokerFailureComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosKafkaBrokerFailure ann) {
