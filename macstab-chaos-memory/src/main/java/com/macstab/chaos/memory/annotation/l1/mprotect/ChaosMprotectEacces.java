...
/**
 * L1 chaos primitive: inject {@code EACCES} on every libchaos-memory-intercepted {@code mprotect}
 ...
 * production rates for {@code EACCES} on {@code mprotect}; {@code 1.0} produces ungrokable failures
