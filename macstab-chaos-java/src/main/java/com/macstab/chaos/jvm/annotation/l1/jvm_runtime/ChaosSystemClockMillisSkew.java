...
/**
 * L1 chaos primitive: skew the value returned from SYSTEM_CLOCK_MILLIS.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#SYSTEM_CLOCK_MILLIS
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.SYSTEM_CLOCK_MILLIS)
