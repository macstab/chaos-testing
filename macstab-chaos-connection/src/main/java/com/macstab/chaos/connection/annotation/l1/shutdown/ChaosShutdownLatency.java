...
/**
 * Delays every libchaos-intercepted {@code shutdown} call by {@link #delayMs} milliseconds before
 ...
 *
 * <p><strong>What chaos this applies:</strong> every {@code shutdown} call intercepted by libchaos
 ...
 * @ChaosShutdownLatency(delayMs = 200)
 * class LatencyTest {
 *   @Test
 ...
 * applies to every capable container. Use the repeatable form ({@code @ChaosShutdownLatencys}) to
