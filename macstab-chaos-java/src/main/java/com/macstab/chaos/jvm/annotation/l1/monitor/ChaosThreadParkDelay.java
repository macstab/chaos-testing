...
/**
 * Delay the thread_park operation by the configured number of milliseconds.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> delay the THREAD_PARK operation by the configured number of milliseconds inside the JVM of the target container.
 ...
 * ({@code @ChaosThreadParkDelays}) to apply different configurations to different containers.
 *
