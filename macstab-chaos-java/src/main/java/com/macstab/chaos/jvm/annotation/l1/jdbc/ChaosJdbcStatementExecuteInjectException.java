 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the JDBC_STATEMENT_EXECUTE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosJdbcStatementExecuteInjectExceptions}) to apply different configurations to different containers.
 *
