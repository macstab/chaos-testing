...
/**
 * Injects {@code EINTR} on every libchaos-intercepted {@code usleep} call inside
 ...
 * {@code usleep}.
 *
 * <p><strong>What chaos this applies:</strong> on every {@code usleep} call that the
 ...
 * @ChaosUsleepEintr(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosUsleepEintrs}) to bind different probabilities to
