 ...
 * safety: each (selector, errno) tuple has its own annotation class with this meta hard-coded, so
 * invalid tuples (per {@link MemorySelector#validErrnos()}) simply have no annotation class.
 *
