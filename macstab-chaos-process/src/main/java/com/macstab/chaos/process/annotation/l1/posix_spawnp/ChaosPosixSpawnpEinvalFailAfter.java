 ...
 * {@code posix_spawnp} calls succeed, then fail every subsequent call with {@code EINVAL}.
 *
 * <p><strong>What this simulates:</strong> deterministic post-warmup failure on posix_spawnp — useful as a test fixture for failure paths that only trigger after the application has settled past startup.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
