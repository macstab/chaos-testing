...
/**
 * Injects {@code EMFILE} on every libchaos-intercepted {@code posix spawn} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEmfiles}) to bind different probabilities to
