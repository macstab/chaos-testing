...
class L3SystemComposersTest {
  ...
  void inodeExhaustion_hasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosSystemInodeExhaustion.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void inodeExhaustion_isRepeatable() {
    assertThat(
            IncidentChaosSystemInodeExhaustion.class.isAnnotationPresent(
  ...
  void tcpTimeWaitStorm_hasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosSystemTcpTimeWaitStorm.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void tcpTimeWaitStorm_isRepeatable() {
    assertThat(
            IncidentChaosSystemTcpTimeWaitStorm.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void fdExhaustion_isRepeatable() {
    assertThat(
            IncidentChaosSystemFdExhaustion.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void directMemoryLeak_hasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosSystemDirectMemoryLeak.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void directMemoryLeak_isRepeatable() {
    assertThat(
            IncidentChaosSystemDirectMemoryLeak.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
  ...
  void swapDeathSpiral_hasChaosL3MetaAnnotation() {
    assertThat(IncidentChaosSystemSwapDeathSpiral.class.isAnnotationPresent(ChaosL3.class))
        .isTrue();
  }
  ...
  void swapDeathSpiral_isRepeatable() {
    assertThat(
            IncidentChaosSystemSwapDeathSpiral.class.isAnnotationPresent(
                java.lang.annotation.Repeatable.class))
        .isTrue();
  }
