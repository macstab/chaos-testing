 ...
 * (selector = {@code WAITPID}, errno = {@code EINTR}, effect = FAIL_AFTER) tuple.
 ...
 * @ChaosWaitpidEintrFailAfter(successesBeforeFailure = 128)
 ...
 * {@code waitpid} calls the application is expected to make before hitting the limit.
 ...
 * ({@code @ChaosWaitpidEintrFailAfter.Repeatable}) to apply different counters to different containers.
 *
