 ...
 * Netty/gRPC off-heap ByteBuffer exhaustion where the heap remains clean but every NIO allocation
 * fails.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class JvmDirectMemoryLeakComposer
    implements L3Composer<IncidentChaosJvmDirectMemoryLeak> {

  public JvmDirectMemoryLeakComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosJvmDirectMemoryLeak ann) {
        ...
        ChaosScenario.builder(id)
            ...
            .effect(
                ChaosEffect.directBufferPressure(
                    ann.totalMb() * 1024L * 1024L, ann.bufferSizeMb() * 1024 * 1024))
  ...
  public List<String> describe(final IncidentChaosJvmDirectMemoryLeak ann) {
    return List.of(
        ...
        "jvm: DirectBufferPressure "
            ...
            + "MB in "
            + ann.bufferSizeMb()
            + "MB buffers (no Cleaner, leak mode)",
