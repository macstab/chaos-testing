...
/**
 * Injects {@code ECONNRESET} on every libchaos-intercepted {@code accept} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosAcceptEconnresets}) to bind different probabilities to
