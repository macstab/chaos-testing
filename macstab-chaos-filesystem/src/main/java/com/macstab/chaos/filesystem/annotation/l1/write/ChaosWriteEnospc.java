...
/**
 * Injects {@code ENOSPC} on every libchaos-intercepted {@code write} call inside the target
 ...
 * exists only because {@code ENOSPC} is a valid POSIX result of {@code write}.
 *
 ...
 * class. Use the repeatable form ({@code @ChaosWriteEnospcs}) to bind different probabilities to
