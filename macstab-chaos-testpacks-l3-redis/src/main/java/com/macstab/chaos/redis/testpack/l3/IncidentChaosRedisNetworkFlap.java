...
/**
 * <h2>What this is</h2>
 * <p>Simulates a Redis Sentinel election storm caused by rapid TCP reset cycling: both CONNECT
 * and RECV operations are hit with ECONNRESET at high toxicity, causing master to appear to
 * change every 200ms as Sentinel sees repeated connectivity loss.
 *
 * <h2>Composed of</h2>
 * <ul>
 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>Clients see master change every 200ms; write chaos
 * ensues as every in-flight command needs to be retried against the newly elected primary.
 *
 * <h2>Industry references</h2>
 * <p>Rapid TCP reset cycling under Sentinel election storms has been observed in high-throughput
 * Redis deployments where network instability triggers cascading promotions faster than clients
 * can converge on a stable master address.
 *
 * <h2>Example</h2>
 * <pre>{@code
 * @AppContainer
...
@ChaosL3(composer = "com.macstab.chaos.redis.testpack.l3.composers.RedisNetworkFlapComposer", severity = Severity.CRITICAL)
