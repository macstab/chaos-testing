 ...
 * @ChaosWildcardEagainFailAfter(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosWildcardEagainFailAfters}) to bind different probabilities to
...
public @interface ChaosWildcardEagainFailAfter {
   ...
   * <p>Example:
   * <pre>{@code
   * @ChaosWildcardEagainFailAfter(id = "primary",  probability = 0.001)
   * @ChaosWildcardEagainFailAfter(id = "replica",  probability = 0.01)
