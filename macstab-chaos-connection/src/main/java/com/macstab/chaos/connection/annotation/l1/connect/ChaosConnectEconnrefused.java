...
/**
 * L1 chaos primitive: inject {@code ECONNREFUSED} on every libchaos-net-intercepted
 * {@code connect} syscall, gated by {@link #toxicity}.
 *
 * <p><strong>What this simulates:</strong> connection refused — peer is up but not listening; canary for service-discovery / port-mapping bugs.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
