...
/**
 * Injects {@code ECONNRESET} on every libchaos-intercepted {@code connect} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosConnectEconnresets}) to bind different probabilities to
