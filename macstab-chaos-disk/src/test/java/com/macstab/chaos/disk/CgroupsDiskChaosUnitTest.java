...
class CgroupsDiskChaosUnitTest {
  ...
  class NullGuards {
    ...
    void injectIOErrorNullContainer() {
      assertThatThrownBy(() -> chaos.injectIOError(null, "/data", "write", "EIO", 0.3))
          .isInstanceOf(NullPointerException.class);
    }
    ...
    void injectIOErrorNullPath() {
      assertThatThrownBy(() -> chaos.injectIOError(container, null, "write", "EIO", 0.3))
          .isInstanceOf(NullPointerException.class);
    }
    ...
    void injectIOErrorNullOperation() {
      assertThatThrownBy(() -> chaos.injectIOError(container, "/data", null, "EIO", 0.3))
          .isInstanceOf(NullPointerException.class);
    }
    ...
    void injectIOErrorNullErrno() {
      assertThatThrownBy(() -> chaos.injectIOError(container, "/data", "write", null, 0.3))
          .isInstanceOf(NullPointerException.class);
    }
    ...
    void injectIOLatencyNullContainer() {
      assertThatThrownBy(
              () -> chaos.injectIOLatency(null, "/data", "write", Duration.ofMillis(100)))
          .isInstanceOf(NullPointerException.class);
    }
    ...
    void injectIOLatencyNullPath() {
      assertThatThrownBy(
              () -> chaos.injectIOLatency(container, null, "write", Duration.ofMillis(100)))
          .isInstanceOf(NullPointerException.class);
    }
    ...
    void injectIOLatencyNullLatency() {
      assertThatThrownBy(() -> chaos.injectIOLatency(container, "/data", "write", null))
          .isInstanceOf(NullPointerException.class);
    }
  ...
  class ContainerRunningGuards {
    ...
    void injectIOErrorStoppedContainer() {
      when(container.isRunning()).thenReturn(false);
      assertThatThrownBy(() -> chaos.injectIOError(container, "/data", "write", "EIO", 0.3))
          .isInstanceOf(IllegalStateException.class)
          .hasMessageContaining("not running");
    }
    ...
    void injectIOLatencyStoppedContainer() {
      when(container.isRunning()).thenReturn(false);
      assertThatThrownBy(
              () -> chaos.injectIOLatency(container, "/data", "write", Duration.ofMillis(100)))
          .isInstanceOf(IllegalStateException.class)
          .hasMessageContaining("not running");
    }
  ...
  class SyscallInjection {
    ...
    void injectIOErrorHappyPath() {
      assertThatCode(() -> chaos.injectIOError(container, "/data", "write", "EIO", 0.3))
          .doesNotThrowAnyException();
    }
    ...
    void injectIOLatencyHappyPath() {
      assertThatCode(
              () -> chaos.injectIOLatency(container, "/data", "fsync", Duration.ofMillis(200)))
          .doesNotThrowAnyException();
    }
