 ...
 */
public final class OkHttpMetastablePoolComposer implements L3Composer<IncidentChaosOkHttpMetastablePool> {

    public OkHttpMetastablePoolComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosOkHttpMetastablePool ann) {
    ...
    public List<String> describe(final IncidentChaosOkHttpMetastablePool ann) {
        return List.of(
                ...
                "connection: RECV latency=" + ann.latencyMs() + "ms (slow connections survive idle cleanup)",
