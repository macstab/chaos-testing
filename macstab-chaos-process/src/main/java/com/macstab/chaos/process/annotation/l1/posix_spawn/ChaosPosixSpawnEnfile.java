...
/**
 * Injects {@code ENFILE} on every libchaos-intercepted {@code posix spawn} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEnfiles}) to bind different probabilities to
