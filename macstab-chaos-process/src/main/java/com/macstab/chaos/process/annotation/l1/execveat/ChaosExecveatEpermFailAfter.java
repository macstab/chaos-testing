 ...
 * {@code execveat} calls succeed, then fail every subsequent call with {@code EPERM}.
 *
 * <p><strong>What this simulates:</strong> deterministic post-warmup failure on execveat — useful as a test fixture for failure paths that only trigger after the application has settled past startup.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @ChaosExecveatEpermFailAfter(successesBeforeFailure = 128)
 * class MyTest { ... }
 * }</pre>
 *
