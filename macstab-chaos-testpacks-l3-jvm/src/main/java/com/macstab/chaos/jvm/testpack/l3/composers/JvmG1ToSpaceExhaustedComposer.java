 ...
 *
 * <p>Applies HeapPressure, GcPressure, and an OutOfMemoryError injection to reproduce the
 * compound failure profile of G1 GC to-space exhaustion under sustained heap pressure with
 * liveness-probe-killing full STW pauses.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class JvmG1ToSpaceExhaustedComposer implements L3Composer<IncidentChaosJvmG1ToSpaceExhausted> {

    public JvmG1ToSpaceExhaustedComposer() {}

    @Override
    public List<Object> apply(final GenericContainer<?> container, final IncidentChaosJvmG1ToSpaceExhausted ann) {
        final List<Object> handles = new ArrayList<>();

        final String heapId = JvmPlanAccumulator.instance().mintScenarioId("JvmG1ToSpaceExhausted-heap");
    ...
    public List<String> describe(final IncidentChaosJvmG1ToSpaceExhausted ann) {
        return List.of(
                ...
                "jvm: HeapPressure " + ann.heapFillMb() + "MB retained + GcPressure " + ann.allocationRateMbPerSec() + "MB/s",
