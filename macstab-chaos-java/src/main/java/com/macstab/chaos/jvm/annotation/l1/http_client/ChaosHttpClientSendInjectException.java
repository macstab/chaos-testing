 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the HTTP_CLIENT_SEND call site inside the JVM of the target container.
 ...
 * ({@code @ChaosHttpClientSendInjectExceptions}) to apply different configurations to different containers.
 *
