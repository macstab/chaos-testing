...
/**
 * L1 chaos primitive: skew the value returned from DATE_NEW.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#DATE_NEW
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JVM_RUNTIME, operationType = OperationType.DATE_NEW)
