...
/**
 * L1 chaos primitive: inject {@code ENOENT} on every libchaos-io-intercepted
 * {@code rename_from} syscall, gated by {@link #probability}.
 *
 * <p><strong>What this simulates:</strong> file or directory not found — typical of race between lookup and unlink.
 *
