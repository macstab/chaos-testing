 ...
 *
 * <h2>How bad it is</h2>
 * <p>Severity: <strong>Critical</strong><br>Once triggered, the failure is self-sustaining: the
 * overloaded backend cannot serve warming requests fast enough for the cache to recover.
 *
...
@ChaosL3(composer = "com.macstab.chaos.cache.testpack.l3.composers.CacheWarmingFailureComposer", severity = Severity.CRITICAL)
