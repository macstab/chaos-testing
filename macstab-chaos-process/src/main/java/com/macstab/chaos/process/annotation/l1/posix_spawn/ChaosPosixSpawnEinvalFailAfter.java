 ...
 * (selector = {@code POSIX_SPAWN}, errno = {@code EINVAL}, effect = FAIL_AFTER) tuple.
 ...
 * ({@code @ChaosPosixSpawnEinvalFailAfter.Repeatable}) to apply different counters to different containers.
 *
