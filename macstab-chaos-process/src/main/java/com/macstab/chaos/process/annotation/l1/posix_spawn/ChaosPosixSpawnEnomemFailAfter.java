 ...
 * = {@code POSIX_SPAWN}, errno = {@code ENOMEM}, effect = FAIL_AFTER) tuple. FAIL_AFTER is the
 ...
 * ({@code @ChaosPosixSpawnEnomemFailAfter.Repeatable}) to apply different counters to different
 * containers.
 *
