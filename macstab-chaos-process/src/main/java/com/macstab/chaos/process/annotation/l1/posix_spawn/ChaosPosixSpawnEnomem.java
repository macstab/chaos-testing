...
/**
 * Injects {@code ENOMEM} on every libchaos-intercepted {@code posix spawn} call inside
 ...
 * class. Use the repeatable form ({@code @ChaosPosixSpawnEnomems}) to bind different probabilities to
