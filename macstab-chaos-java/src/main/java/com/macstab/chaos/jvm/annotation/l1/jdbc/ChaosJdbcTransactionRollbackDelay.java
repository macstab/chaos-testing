...
/**
 * L1 chaos primitive: delay the JDBC_TRANSACTION_ROLLBACK operation by the configured number of milliseconds.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
 ...
 * @see com.macstab.chaos.jvm.api.OperationType#JDBC_TRANSACTION_ROLLBACK
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.JDBC, operationType = OperationType.JDBC_TRANSACTION_ROLLBACK)
