 ...
 * reproduce the compound failure profile of a Redis Sentinel election storm with concurrent NTP
 * correction.
 *
 * @author Christian Schnapka - Macstab GmbH
 */
public final class RedisFailoverStormComposer
    implements L3Composer<IncidentChaosRedisFailoverStorm> {

  public RedisFailoverStormComposer() {}

  @Override
  public List<Object> apply(
      final GenericContainer<?> container, final IncidentChaosRedisFailoverStorm ann) {
