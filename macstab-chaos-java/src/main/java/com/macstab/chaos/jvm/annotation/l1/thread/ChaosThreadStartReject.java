...
/**
 * L1 chaos primitive: reject the THREAD_START operation by throwing an appropriate exception for the operation type.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
@JvmInterceptorBinding(selectorKind = JvmSelectorKind.THREAD, operationType = OperationType.THREAD_START)
