...
/**
 * Throw the configured exception at the socket_write call site.
 *
 ...
 *
 * <p><strong>What chaos this applies:</strong> throw the configured exception at the SOCKET_WRITE call site inside the JVM of the target container.
 ...
 * ({@code @ChaosSocketWriteInjectExceptions}) to apply different configurations to different containers.
 *
