...
/**
 * Injects {@code EPERM} on every libchaos-intercepted {@code execve} call inside the target
 ...
 * exists only because {@code EPERM} is a valid POSIX result of {@code execve}.
 *
