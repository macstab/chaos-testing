...
/**
 * Injects {@code EINVAL} on every libchaos-intercepted {@code nanosleep} call inside
 ...
 * @ChaosNanosleepEinval(probability = 0.001)
 * class FaultTest {
 *   @Test
 ...
 * class. Use the repeatable form ({@code @ChaosNanosleepEinvals}) to bind different probabilities to
